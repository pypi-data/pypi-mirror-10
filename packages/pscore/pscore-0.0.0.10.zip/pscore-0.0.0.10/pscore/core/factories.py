...
class WebDriverFactory:
    @staticmethod
    def get(logger, test_name="Python core framework"):
        """
        ...
        if desired_execution_environment == ENVIRONMENT_LOCAL:
            ...
            driver = WebDriverFactory.get_sauceabs_driver(logger, test_name, desired_browser, desired_browser_version)
        else:
    ...
    @staticmethod
    def get_sauceabs_driver(logger, test_name, browser, version=None):
