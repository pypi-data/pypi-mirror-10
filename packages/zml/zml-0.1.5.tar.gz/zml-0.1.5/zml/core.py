...
class Template(object):
    ...
    def _rendercode(self, zmlcode=None, context=None,
        ...
        #inline_content.leaveWhitespace()
        ...
        element = indentobj('indent') + name('name') + id_classes('id_classes')
        ...
        hasInlineColon = indentobj('indent') + name('name')
        ...
        for i, line in enumerate(lines):
            ...
            if code_block_active:
                ...
                if line.strip().startswith('#'):
                    ...
                    for l in componentcode.split('\n'):
                        compo += ' ' * 2 * code_indent_level + l + '\n'
                    # _childs context item is deprecated and will be removed in the next release
                    cr = render(compo, {'_children': childitems, '_childs': childitems})
                    componentres = cr
