...
class SecurityCenter5(object):
    ...
    def _builder(self, path, **kwargs):
        ...
        kwargs['url'] = '%s://%s:%s/rest/%s' % (self._scheme, self._host, self._port, path)
