...
class TestP4(TestP4Python):
    ...
    def testLogger( self ):
        ...
        d = { 'debugCalled' : False, 'infoCalled' : False }
        ...
        self.p4.logger = m
        self.assertEqual(self.p4.logger, m, "Logger not set correctly")
        self.assertEqual(self.p4.debug, 0, "Debug has not 0")
        
        self.p4.run_info()
        
        self.assertTrue(d['debugCalled'], "Logger was not called with debug")
        self.assertTrue(d['infoCalled'], "Logger was not called with info")
    ...
    def testDVCS( self ):
        ...
        if self.p4.server_level >= 39:
            ...
            try:
                dvcs = P4.init(directory="dvcs",unicode=True,charset="utf8")
                dvcs.connect()
                ...
                self.fail("P4.run_init() raised exception {}".format(e))
