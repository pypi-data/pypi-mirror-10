...
class Session():
    ...
    def __init__(self, parent, cookie_jar=None, request=None):
        ...
        if not request:
            raise DissectException('Request object not provided.')

        if not cookie_jar:
            raise DissectException('Cookie jar object not provided.')
