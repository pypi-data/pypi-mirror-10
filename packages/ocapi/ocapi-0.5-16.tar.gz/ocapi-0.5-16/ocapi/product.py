...
class CabinetMaker(object):
    ...
    def add_doors(self, area_id=None,diff=None,door_type='AUTOMAT',grains=True,handleHeight='TOP',handleOrientation='VERTICAL',handlePos=[50, 50],handleSide=None,handleSize=[160, 25, 5],info=None,mat=None,number=None,pars_front=[3, 3, 3, 3, 3],post_diff=None,save=True,stacking='HORIZONTAL',style='FLAT'):
        '''
    ...
    def add_frame(self, area_id=None,diff=None,diff_fill=[0, 0, 5, 0, 0, 0],edge_fill=None,edge_frame=None,info=None,insert_fill=True,low_profile=True,mat=None,mat_fill=None,order=[0, 1, 2, 3],planes=None,post_diff=None,save=True,thick=None,thick_fill=None,width=None):
        '''
    ...
    def add_label(self, area_id=None,center=True,pos=None,save=True,text=None):
        '''
    ...
    def add_backside(self, area_id=None,diff=None,groove=7,info=None,mat=None,offset=None,planes=3,save=True,thickness=None):
        '''
        ...
        :param info: element info object as ``{'fittings':{}, 'production':{},'visibility':'BACK'}``
        :type info: dict
        :param groove: depth of all grooves 15, or list ``[x left,x right,z bottom,z top]``
        :type groove: int or list
        :param offset: 0,3,5,7,18 - insert -> thickness offset of element near to back of main construction
        :type offset: int
    ...
    def add_element(self, area_id=None,diff=None,edge=None,info=None,mat=None,name=None,number=None,pos=None,rot=None,save=True,size=None,typ=None):
        '''
    ...
    def add_socle(self, area_id=None,bottom=50,diff=[0, 0, 2, 0, 0, 0],info=None,left=None,mat=None,order=[0, 1, 2, 3],right=None,save=True,top=None):
        '''
    ...
    def add_area(self, area_id=None,diff=None,dims=True,kind=None,name=None,pos=None,save=True,size=None,typ=None):
        '''
        ...
        :param save: save function
        :type save: boolean
        :param kind: kind of area, None = normal, 'DRAWER' = area for drawers only - draw_id
