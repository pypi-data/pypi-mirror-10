...
def connect(hostname, username, password=None, private_key_files=[], private_keys=[]):
    """
...
class _SSHConnectionImpl(object):
    ...
    def open_sftp(self):
        ...
        self._connection.openChannel(channel)
        return channel.sftp_connection_d
...
class _ExecutionChannel(channel.SSHChannel):
    ...
    def closed(self):
        ...
        try:
            ...
            reactor.callLater(0, self._exited, failure.Failure())
    ...
    def request_exit_status(self, data):
        ...
        reactor.callLater(0, self._exited, result)
