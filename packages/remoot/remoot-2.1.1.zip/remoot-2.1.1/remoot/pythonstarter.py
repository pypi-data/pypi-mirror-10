...
class EC2Starter(object):
    ...
    def __init__(self, provider, provider_keyid, provider_key, image_id, size_id, public_key_file, private_key_file, tmp_dir):
        self._starter = starter.EC2Starter(provider, provider_keyid, provider_key, image_id, size_id, public_key_file, private_key_file, tmp_dir)
