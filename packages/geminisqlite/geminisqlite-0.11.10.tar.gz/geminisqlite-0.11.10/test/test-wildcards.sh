...
T/T	T/C	T/C	T/T
C/T	C/C	C/C	C/C" > exp
geminisqlite query -q "select (gts).(*)from variants" extended_ped.db > obs
check obs exp
rm obs exp
...
geminisqlite query --header -q "select chrom, start, end, ref, alt, (gts).(*)from variants" extended_ped.db > obs
check obs exp
rm obs exp
...
geminisqlite query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype==1) from variants" extended_ped.db > obs
check obs exp
rm obs exp
...
geminisqlite query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype==1) from variants" \
...
geminisqlite query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype==1), (gt_types).(phenotype==1) from variants" \
             --gt-filter "(gt_types).(phenotype==1).(==HOM_REF).(all)" extended_ped.db > obs
check obs exp
rm obs exp
...
geminisqlite query --header -q "select chrom, start, end, ref, alt, (gts).(phenotype==2) from variants" \
...
chr10	135369531	135369532	T	C	T/T	T/C	T/C	T/T
chr16	72057434	72057435	C	T	C/T	C/C	C/C	C/C" > exp
geminisqlite query --header -q "select chrom, start, end, ref, alt, (gts).(*) from variants" \
...
geminisqlite query --header -q "select chrom, start, end, ref, alt, gene, (gts).(*) from variants" \
