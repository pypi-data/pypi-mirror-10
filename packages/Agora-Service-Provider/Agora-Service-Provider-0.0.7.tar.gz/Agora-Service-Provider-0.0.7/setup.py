...
setup(
    ...
    packages=['agora', 'agora.provider', 'agora.provider.jobs', 'agora.provider.server'],
    namespace_packages=['agora', 'agora.provider', 'agora.provider.server', 'agora.provider.jobs'],
