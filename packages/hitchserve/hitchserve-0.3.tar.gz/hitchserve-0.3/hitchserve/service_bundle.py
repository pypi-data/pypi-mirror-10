...
class ServiceBundle(object):
    ...
    def start_interactive_mode(self):
        ...
        sys.stdout.write("{}{}{}".format(colorama.Fore.RESET, colorama.Back.RESET, colorama.Style.RESET_ALL).encode("utf8"))
        sys.stderr.write("{}{}{}".format(colorama.Fore.RESET, colorama.Back.RESET, colorama.Style.RESET_ALL).encode("utf8"))
