...
$("#crear_txt").on("click",function(){
	...
	checked_repos.each(function(){
		...
		dic_diot[rfc]['detalles'].push([String(folio),subtotal,iva])
...
$("#export_excel").on("click",function(){
	...
	$("#tabla_repositorios").find("tbody tr:visible").each(function(){
		...
		var iva_descuentos = $(this).find("#iva_descuentos").text().replace("$ ","").trim()
		var iva_retenido = $(this).find("#iva_retenido").text().replace("$ ","").trim()
