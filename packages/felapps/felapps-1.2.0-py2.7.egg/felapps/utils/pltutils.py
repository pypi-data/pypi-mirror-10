...
class AppConfigPanel(wx.Frame):
    ...
    def createNotebooks(self):
        ...
        # config notebook
        self.configNB = ConfigNoteBook(self)
    ...
    def setParams(self):
        ...
        self.thisapp.imgsrcPV   = self.thisapp.imgsrc_tc.GetValue()
        self.thisapp.timer_freq = int(self.imagePage.freqtc.GetValue())
...
class StyleConfigPanel(wx.Panel):
    ...
    def createPanel(self):
        ...
        hboxbtn.Add(self.bkgdcolortc,  proportion = 1, flag = wx.EXPAND | wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
        hboxbtn.Add(self.bkgdcolorbtn, proportion = 0, flag = wx.LEFT | wx.ALIGN_CENTER_VERTICAL, border = 10)
