...
class Item(CachedObject):
    ...
    name_key = 'name'
    application_data_key = 'application_data'
    ...
    def name(self):
        ...
        :rtype: String
        """
        return self._get(self.name_key)

    @name.setter
    def name(self, new_name):
        self._set(self.name_key, new_name)
    ...
    def application_data(self, new_application_data):
        ...
        self._set(self.application_data_key, new_application_data)
