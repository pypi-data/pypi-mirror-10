    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output_path', models.FilePathField(path=b'/home/chris/github/djangui/djtest/djtest/user_uploads', max_length=255, allow_files=False, recursive=True, allow_folders=True)),
