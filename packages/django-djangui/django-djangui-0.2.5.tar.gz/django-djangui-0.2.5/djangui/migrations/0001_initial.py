    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(populate_from=b'script_name', unique=True, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(populate_from=b'group_name', unique=True, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(populate_from=b'script_param', unique=True, editable=False)),
                ('is_output', models.BooleanField(default=None)),
                ('required', models.BooleanField(default=False)),
                ('output_path', models.FilePathField(path=b'/home/chris/Devel/nt4/nt4/user_uploads', max_length=255, allow_files=False, recursive=True, allow_folders=True)),
