...
class Asset(object):
    ...
    def get_asset_structure(self, asset=None):
        if asset:
            self.set_asset(self.ws.build_asset_structure(self.asset))

        return self.ws.build_asset_structure(self.asset)
    ...
    def data_def(self, asset=None):
        if asset:
            self.set_asset(asset)
        return self.get_asset_structure(self.asset)['asset']['xhtmlDataDefinitionBlock']

    def data_def_path(self):
        return self.asset['definitionPath']

    def nodes(self):
        return self.asset['structuredDataNodes']['structuredDataNode']
