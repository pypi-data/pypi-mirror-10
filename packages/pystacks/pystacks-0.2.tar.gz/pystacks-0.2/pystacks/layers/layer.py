...
class Layer(object):
    ...
    def forward(self, a):
        """ A wrapper around the ``forward_(a)`` function. The user should not implement this function.

        :param a: inputs into the layer
        :return: output from the layer given ``forward_(a)``
        """
        return self.forward_(a)

    def forward_(self, a):
        """ Computes the forward activation of this ``Layer``. The user should implement this function
