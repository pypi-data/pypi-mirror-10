...
_WBWombat = (function() {
    ...
    //============================================
    //Define W.apply(window.location.href);ombatLocation
...
//        }
    ...
    function copy_history_func(history, func_name) {
        ...
        function rewritten_func(state_obj, title, url) {
            url = rewrite_url(url);
            console.log(url);
            result = orig_func.call(history, state_obj, title, url);
            //WombatLocation.call(window.WB_wombat_location, window.location);
            return result;
        }
    ...
    function init_dom_override() {
        ...
        function replace_dom_func(funcname) {
            ...
            Node.prototype[funcname] = function() {
                ...
                //    desc = child.querySelectorAll("a[href]");
                //} else if (child.getElementsByTagName) {
                //    desc = child.getElementsByTagName("*");
                //}
                if (child.querySelectorAll) {
                    desc = child.querySelectorAll("[href], [src], [srcset]");
                }
