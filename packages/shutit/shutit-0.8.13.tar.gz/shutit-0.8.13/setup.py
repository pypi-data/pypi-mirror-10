...
setup(
	...
	data_files=[('words',['assets/words']),('shutit_module_template_bare.py',['assets/shutit_module_template_bare.py']),('shutit_module_template.py',['assets/shutit_module_template.py']),('rezize',['assets/resize'])],
