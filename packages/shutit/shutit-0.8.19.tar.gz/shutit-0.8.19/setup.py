...
setup(
	...
	data_files=[('shutit_assets',['assets/words']),('shutit_assets',['assets/shutit_module_template_bare.py']),('shutit_assets/shutit_module_template.py',['assets/shutit_module_template.py']),('shutit_assets',['assets/resize'],('.gitignore',['assets/gitignore']))],
