...
setup(
	...
	data_files=[('shutit_assets',['src/assets/words']),('shutit_assets',['src/assets/shutit_module_template_bare.py']),('shutit_assets',['src/assets/shutit_module_template.py']),('shutit_assets',['src/assets/resize']),('shutit_assets',['src/.gitignore'])],
