...
-  `FFmpeg <https://ffmpeg.org/download.html>`__ 2+ compiled with libvpx
   and libopus
-  *`mpv <http://mpv.io/installation/>`__ 0.8+ compiled with Lua
   support, for interactive mode only*
...
.. |image0| image:: http://dump.bitcheese.net/images/otipulo/22.png
   :target: http://dump.bitcheese.net/images/iwoguse/2.png
