...
class SupervisorRestartable(Restartable):
    ...
    def do_restart(self):
        subprocess.check_call(['service', SupervisorImpl.any(self.context).service_name, 'stop'])
        subprocess.check_call(['service', SupervisorImpl.any(self.context).service_name, 'start'])
