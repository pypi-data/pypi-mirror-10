...
class Trader(object):
    ...
    The handlers can be used to subclass simulated Traderages
    or live Traderages, with identical interfaces. This allows
...
class SimulateTrader(Trader):
    """
    Handles order execution via the Interactive Traders
    ...
    def create_initial_order_id(self):
            ...
            Traders to keep track of submitted orders.
            """
    ...
    def execute_order(self, event):
            """
            Creates the necessary InteractiveTraders order object
            ...
            """
                ...
                ## Create the Interactive Traders contract via the 
                ## passed Order event
                ...
                ## Create the Interactive Traders order via the 
                ## passed Order event
