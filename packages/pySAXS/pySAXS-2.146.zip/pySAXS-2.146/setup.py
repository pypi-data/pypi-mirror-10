...
setup(name='pySAXS',
      ...
      package_dir={'pySAXS' : '.'},
      packages=['pySAXS','pySAXS.LS','pySAXS.guisaxs','pySAXS.guisaxs.wx','pySAXS.guisaxs.qt',\
                'pySAXS.models','pySAXS.tools','pySAXS.models.super','pySAXS.examples','pySAXS.mcsas','pySAXS.fileformat'],
      #all files (.dat or pdf) are specified in MANIFEST.in
      package_data = {'pySAXS' : ['doc/*','saxsdata/*','guisaxs/wx/*.gif','guisaxs/qt/*.*','guisaxs/images/*.*','guisaxs/ui/*.*','*.txt','xraylib/*']},
