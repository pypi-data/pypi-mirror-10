...
class Visualisation (Scene):
	...
	def display (self, world):
		self.base (0, lambda:
			self.torso (world.robot.torAng, lambda:
				self.upperArm (world.robot.uppAng, lambda:
					self.foreArm (world.robot.forAng, lambda:
						self.wrist (world.robot.wriAng, lambda:
							self.handCenter (world.robot.hanAng, lambda:
								self.handSide0 (0) +
								self.handSide1 (0) +
								self.handSide2 (0) +
								self.handSide3 (0) +
								self.finger0 (world.robot.finAng) +
								self.finger1 ( world.robot.finAng) +
								self.finger2 ( world.robot.finAng) +
								self.finger3 (world.robot.finAng)
		)	)	)	)	)	)
