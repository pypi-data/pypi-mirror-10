...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostAttr.is_active'
        db.add_column(u'dbaas_nfsaas_hostattr', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostAttr.is_active'
        db.delete_column(u'dbaas_nfsaas_hostattr', 'is_active')
