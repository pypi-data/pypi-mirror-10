...
(function(tp) {
    ...
    tp.SSEChannelListener = (function() {
        ...
        _.prototype.bind = function(event, callback) {
            ...
            for (var i = 0; i < event.length; i++) {
                this.source.addEventListener(event[i], function(e) {
                    debug("Received event: " + event[i]);
        ...
        _.prototype.message_handler = function(e) {
            debug("Received event: " + e.type);
            this.dispatch(e.type, tp.decode_data(e.data));
        };
    ...
    tp.WebSocketChannelListener = (function() {
        ...
        _.prototype.message_handler = function(e) {
            ...
            this.dispatch(event, tp.decode_data(data));
        };
