...
def get_linked_container_variables(args):
    envs = {}
    print "Check link variables", args
    if "--link" in args:
        print "Found --link option"
        ...
        print "Found the following variables", exposed_ports, linked_envs, ip_address
        if current_name:
