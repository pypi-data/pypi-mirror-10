...
REDIS_HOST = os.environ.get("REDYLITICS_", "localhost")
REDIS_PORT = os.environ.get("REDYLITICS_", 6379)
REDIS_DB = os.environ.get("REDYLITICS_", 0)
REDIS_PASSWORD = os.environ.get("REDYLITICS_", None)
...
LOGGER.info(REDYLITICS_PAGEVIEW_CLIENT_WRITE_CHANNEL_REGEX)
LOGGER.info(REDYLITICS_PAGEVIEW_CLIENT_WRITE_DATE_REGEX)
LOGGER.info(REDYLITICS_PAGEVIEW_CLIENT_READ_CHANNEL_REGEX)
LOGGER.info(REDYLITICS_PAGEVIEW_CLIENT_READ_DATE_REGEX)
LOGGER.info(REDYLITICS_PAGEVIEW_CLIENT_DATE_EXTRACTION_REGEX)
LOGGER.info(VIDEO_EVENT_REGEX)
LOGGER.info(VIDEO_CLIENT_PREFIX)
LOGGER.info(VIDEO_AD_CLIENT_PREFIX)
LOGGER.info(REDIS_KWARGS)
