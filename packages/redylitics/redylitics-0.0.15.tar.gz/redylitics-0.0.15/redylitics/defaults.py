...
DEF_VIDEO_EVENT_REGEX_PATTERN = "^(impression|start|complete|firstQuartile|midpoint|thirdQuartile)$"
...
DEF_VIDEO_AD_EVENT_REGEX_PATTERN = "^(impression|start|complete|firstQuartile|midpoint|thirdQuartile)$"
