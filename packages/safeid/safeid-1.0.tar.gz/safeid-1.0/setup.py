...
setup(name='safeid',
      ...
      url='http://pages.cs.wisc.edu/~ace/pythia.html',
      download_url='https://bitbucket.org/ace0/safeid/get/1.0.zip',
      author='Adam Everspaugh',
      author_email='ace@cs.wisc.edu',
      license='MIT',
      keywords='password encryption authentication',
      packages=['safeid'],
      # TODO: Add pythia package once we have a name for it.
      install_requires=['httplib2', 'pythia'],
      zip_safe=False, 
