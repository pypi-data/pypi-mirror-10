...
def scatterplot(inst,labelx,labely, data_label, datalim, xlim=None, ylim=None):
    """Return scatterplot of data_label as functions of labelx,y over a season.
    ...
    data_label : string 
        data product to be scatter plotted
    datalim : numyp array 
        plot limits for data_label

    Summary
    -------
    Returns a scatter plot of data_label as a function of label1 and label2 
    over the season delineated by start and stop datetime objects.
