...
.. autoclass:: abjad.tools.instrumenttools.TenorTrombone.TenorTrombone
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_instrumenttools {
           ...
           "instrumenttools.Instrument" [color=3,
               ...
               label=Instrument,
               shape=box];
           "instrumenttools.TenorTrombone" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>TenorTrombone</B>>,
               shape=box,
               style="filled, rounded"];
           "instrumenttools.Instrument" -> "instrumenttools.TenorTrombone";
       }
