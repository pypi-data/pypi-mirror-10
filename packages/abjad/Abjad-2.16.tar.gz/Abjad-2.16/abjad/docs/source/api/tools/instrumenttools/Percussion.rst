...
.. autoclass:: abjad.tools.instrumenttools.Percussion.Percussion
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_instrumenttools {
           ...
           "instrumenttools.Instrument" [color=3,
               ...
               label=Instrument,
               shape=box];
           "instrumenttools.Percussion" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>Percussion</B>>,
               shape=box,
               style="filled, rounded"];
           "instrumenttools.Instrument" -> "instrumenttools.Percussion";
       }
