...
.. autoclass:: abjad.tools.durationtools.Duration.Duration
...
.. graphviz::
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_durationtools {
           ...
           "durationtools.Duration" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>Duration</B>>,
               shape=box,
               style="filled, rounded"];
           "durationtools.Multiplier" [color=3,
               group=2,
               label=Multiplier,
               shape=box];
           "durationtools.Offset" [color=3,
               group=2,
               label=Offset,
               shape=box];
...
.. only:: html
   ...
   .. autosummary::
      ...
      ~abjad.tools.durationtools.Duration.Duration.__nonzero__
...
.. automethod:: abjad.tools.durationtools.Duration.Duration.__nonzero__
   :noindex:
