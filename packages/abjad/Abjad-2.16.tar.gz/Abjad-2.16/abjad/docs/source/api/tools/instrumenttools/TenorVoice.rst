...
.. autoclass:: abjad.tools.instrumenttools.TenorVoice.TenorVoice
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_instrumenttools {
           ...
           "instrumenttools.Instrument" [color=3,
               ...
               label=Instrument,
               shape=box];
           "instrumenttools.TenorVoice" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>TenorVoice</B>>,
               shape=box,
               style="filled, rounded"];
           "instrumenttools.Instrument" -> "instrumenttools.TenorVoice";
       }
