...
.. autoclass:: abjad.tools.scoretools.FixedDurationTuplet.FixedDurationTuplet
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_scoretools {
           ...
           "scoretools.Container" [color=3,
               ...
               label=Container,
               shape=box];
           "scoretools.FixedDurationTuplet" [color=black,
               fontcolor=white,
               group=2,
...
- :py:class:`scoretools.Tuplet <abjad.tools.scoretools.Tuplet.Tuplet>`
