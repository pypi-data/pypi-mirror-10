...
.. autoclass:: abjad.tools.instrumenttools.MezzoSopranoVoice.MezzoSopranoVoice
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_instrumenttools {
           ...
           "instrumenttools.Instrument" [color=3,
               ...
               label=Instrument,
               shape=box];
           "instrumenttools.MezzoSopranoVoice" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>MezzoSopranoVoice</B>>,
               shape=box,
               style="filled, rounded"];
           "instrumenttools.Instrument" -> "instrumenttools.MezzoSopranoVoice";
       }
