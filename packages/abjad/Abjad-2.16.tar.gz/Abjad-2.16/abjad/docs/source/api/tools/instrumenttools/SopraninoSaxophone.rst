...
.. autoclass:: abjad.tools.instrumenttools.SopraninoSaxophone.SopraninoSaxophone
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_instrumenttools {
           ...
           "instrumenttools.Instrument" [color=3,
               ...
               label=Instrument,
               shape=box];
           "instrumenttools.SopraninoSaxophone" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>SopraninoSaxophone</B>>,
               shape=box,
               style="filled, rounded"];
           "instrumenttools.Instrument" -> "instrumenttools.SopraninoSaxophone";
       }
