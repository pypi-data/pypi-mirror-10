...
.. autoclass:: abjad.tools.timespantools.AnnotatedTimespan.AnnotatedTimespan
...
.. graphviz::
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_mathtools {
           ...
           "mathtools.BoundedObject" [color=3,
               group=2,
               label=BoundedObject,
               shape=box];
       }
       subgraph cluster_timespantools {
           ...
           "timespantools.AnnotatedTimespan" [color=black,
               fontcolor=white,
               group=3,
...
- :py:class:`timespantools.Timespan <abjad.tools.timespantools.Timespan.Timespan>`

- :py:class:`mathtools.BoundedObject <abjad.tools.mathtools.BoundedObject.BoundedObject>`
