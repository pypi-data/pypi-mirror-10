...
.. autoclass:: abjad.tools.datastructuretools.CyclicMatrix.CyclicMatrix
...
.. graphviz::
   ...
   digraph InheritanceGraph {
       ...
       subgraph cluster_datastructuretools {
           ...
           "datastructuretools.CyclicMatrix" [color=black,
               fontcolor=white,
               group=2,
               label=<<B>CyclicMatrix</B>>,
               shape=box,
               style="filled, rounded"];
           "datastructuretools.Matrix" [color=3,
               group=2,
               label=Matrix,
               shape=box];
...
- :py:class:`datastructuretools.Matrix <abjad.tools.datastructuretools.Matrix.Matrix>`
