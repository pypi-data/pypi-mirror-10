...
def getPackageVersion(pkgName):
    ...
    NOTE: we use this egg package version for versioning per resource file
    as a fallback for svn version based resource versioning for any non
    svn resource file.
    """
...
def cdnResource(_context, name, manager=u'', layer=p01.cdn.layer.ICDNRequest,
    ...
    pkgVersion = getPackageVersion(pkgName)
