...
class VmStack(stacks.Stack):
    ...
    def __init__(self, name):
        ...
        * the no-name section in /etc/uci-vms.conf
        ...
        super().__init__(
            [self.cmdline_store.get_sections,
...
register(options.ListOption('vm.lxc.set_ip_timeouts', default='0, 60, 10',
                            help_string='''\
...
'''))
register(options.ListOption('vm.lxc.ssh_setup_timeouts', default='0, 60, 10',
                            help_string='''\
