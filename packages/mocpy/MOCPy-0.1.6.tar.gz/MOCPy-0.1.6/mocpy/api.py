...
if __name__ == '__main__':
    ...
    t = Table.read('http://cdsxmatch.u-strasbg.fr/QueryCat/QueryCat?catName=SIMBAD&mode=allsky&format=csv&col=ra,dec&limit=8000000', format='ascii.csv')
    #import cProfile
    #cProfile.run("moc = MOC.from_table(t, 'ra', 'dec', 5)", 'restats')
    #import pstats
    #p = pstats.Stats('restats')
    #p.sort_stats('time').print_stats(10)
    moc = MOC.from_table(t, 'ra', 'dec', 5)

    moc.write('/tmp/simbad.moc')
