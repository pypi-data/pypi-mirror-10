...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_xcffib_cffi_bcb17702x903695b1",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__xcffib_cffi_bcb17702x903695b1(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_xcffib_cffi_bcb17702x903695b1(void)
{
  PyObject *lib;
  lib = Py_InitModule("_xcffib_cffi_bcb17702x903695b1", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
