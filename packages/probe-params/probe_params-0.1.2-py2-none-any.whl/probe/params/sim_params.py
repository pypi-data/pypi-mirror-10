...
class SimParams(object):
    ...
    def __init__(self, file_with_params, input_params=True, **kwargs):

        self.debye_fraction_user = kwargs.get('debye_fraction_user', None)
        if input_params:
    ...
    def compute_sparams(self, params, cparams, **kwargs):
        debye_fraction_user = kwargs.get('debye_fraction_user', None)
