...
class Controller:
	...
	def add_wlan(self, ssid, wlangroup, usergroup, password = False, is_guest = True):
		params = dict()
		
		defaults = '{"name":"","security":"open","x_passphrase":"","wep_idx":"1","x_wep":"","enabled":true,"radius_ip_1":"","radius_port_1":"1812","x_radius_secret_1":"","vlan_enabled":false,"vlan":"","hide_ssid":false,"wpa_mode":"auto","wpa_enc":"ccmp","usergroup_id":"","wlangroup_id":""}'
