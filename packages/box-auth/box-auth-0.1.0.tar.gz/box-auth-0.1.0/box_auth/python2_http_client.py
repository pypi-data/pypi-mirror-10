...
class HttpClient(IHttpClient):
    """
    Uses python 2 standard library in a pretty messy way
    """
    ...
    def post(self, url, post_data, headers=None):
        ...
        try:
            ...
            content = ''.join([line for line in response])
    ...
    def post_form(self, url, post_data, headers=None):
        ...
        return self.post(url, urllib.urlencode(post_data), headers)
    ...
    def query_params(self, url):
        ...
        :return dict:
        """
        list_of_pairs = map(lambda s: s.split('='), urlparse.urlparse(url).query.split('&'))
        query_params = {}
