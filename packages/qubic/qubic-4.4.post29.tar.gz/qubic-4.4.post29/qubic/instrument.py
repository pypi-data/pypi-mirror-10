...
class QubicInstrument(SimpleInstrument):
    ...
    def _get_synthbeam_healpix(self, scene, x, y, area, nu, bandwidth,
                               theta_max=45):
        """
        ...
        >>> sb = inst._get_synthbeam_healpix(scene, xpos, ypos, 1, nu,
                                             bandwidth)
    ...
    def get_synthbeam_healpix(self, scene, idetector, theta_max=45):
        """
        ...
        >>> scene = QubicScene(1024)
        >>> inst = QubicInstrument()
        >>> sb = inst.get_synthbeam_healpix(scene, 0)
        ...
        return self._get_synthbeam_healpix(self, scene, x, y, a, nu, bandwidth,
                                           theta_max)
