...
class MakeBaseProject(TemplateCommand):
    ...
    def take_action(self, opts):
        ...
        os.system("rm -R {dir}".format(dir=REPOSITORY_CLONE_DIR))
        ...
        os.system("cp -R {temp_repo}/release-repo/ios/release ./{output_dir}/ios/axemas".format(
            temp_repo=REPOSITORY_CLONE_DIR, output_dir=opts.output_dir))
        os.system("cp -R {temp_repo}/release-repo/android/axemas.aar ./{output_dir}/android/app/libs".format(
            temp_repo=REPOSITORY_CLONE_DIR, output_dir=opts.output_dir))
        os.system("cp -R {temp_repo}/release-repo/html/ ./{output_dir}/axemas-js/".format(
            temp_repo=REPOSITORY_CLONE_DIR, output_dir=opts.output_dir))
