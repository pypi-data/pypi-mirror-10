...
def rate_code(cnt, fp, showhints):
    ...
    print("\033[34m" + str(cnt) + ". " + os.path.join(os.path.basename(os.path.dirname(fp)), os.path.basename(fp)) + ":\033[34m", result1, "\033[90m" + result2, "\033[0m", result)
...
def main():
    ...
    for fp in checkfiles:
        cnt += 1
        rate_code(cnt, fp, arguments.showhints)
