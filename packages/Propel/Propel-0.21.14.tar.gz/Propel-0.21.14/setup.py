...
setup(
    ...
    # NOTE
    # Supervisor is not yet Py3 compatible, but github master is
    # So we'll use the master for now
    dependency_links=[
        "https://github.com/Supervisor/supervisor/tarball/master.tar.gz#egg=supervisor_wip-4.0.0dev"
    ],
    install_requires=[
        'jinja2==2.7.3',
        'pyyaml==3.11',
        'virtualenvwrapper==4.5.1',
        'supervisor_wip==4.0.0dev'
    ],
