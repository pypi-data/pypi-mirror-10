...
setup(
    ...
    # NOTE
    # PIP Supervisor is not compatible to PY3, but the master git branch is
    # So we'll use the master for now
    dependency_links=[
        "git+ssh://github.com/Supervisor/supervisor.git@c3e53477058f5ecf788862eb1c4b3195d7539be0#egg=supervisor=4.0.0.dev0"
    ],
