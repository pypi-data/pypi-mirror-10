...
def make_hipchat_blueprint(
        client_id=None, client_secret=None, scope=None,
        redirect_url=None, redirect_to=None,
        login_url=None, authorized_url=None, capabilities_url=None,
    ...
    Args:
        ...
        authorized_url (str, optional): the URL path for the ``authorized`` view.
            Defaults to ``/hipchat/authorized``.
        capabilities_url (str, optional): the URL path for the `capabilities
            descriptor`_. Defaults to ``/hipchat/capabilities``
    ...
    .. _capabilities descriptor: https://www.hipchat.com/docs/apiv2/addons#capabilities_descriptor
    """
