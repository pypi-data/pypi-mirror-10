...
setup(
    ...
    license='LGPLv3',
    description="""Use json to serialize unsupported python types (and many more including functions, classes, exceptions, etc). Changes: Better support for memoryview.""",
