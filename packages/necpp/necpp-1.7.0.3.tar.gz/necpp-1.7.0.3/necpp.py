...
def nec_medium_parameters(*args):
  return _necpp.nec_medium_parameters(*args)
...
def nec_excitation_voltage(*args):
  return _necpp.nec_excitation_voltage(*args)
nec_excitation_voltage = _necpp.nec_excitation_voltage

def nec_excitation_current(*args):
  return _necpp.nec_excitation_current(*args)
nec_excitation_current = _necpp.nec_excitation_current

def nec_excitation_planewave(*args):
  return _necpp.nec_excitation_planewave(*args)
