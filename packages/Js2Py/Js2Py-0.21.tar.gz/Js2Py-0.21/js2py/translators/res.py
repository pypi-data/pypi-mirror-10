...
def PyJs_anonymous_0_(exports, this, arguments, var=var):
    ...
    def PyJsHoisted_testRegExp_(pattern, flags, this, arguments, var=var):
        ...
        try:
            ...
            PyJsHolder_65_27133753 = var.own.get(u'e')
            var.force_own_put(u'e', PyExceptionToJs(PyJsTempException))
            try:
                var.get(u'throwUnexpectedToken')(var.get(u"null"), var.get(u'Messages').get(u'InvalidRegExp'))
            finally:
                if PyJsHolder_65_27133753 is not None:
                    var.own[u'e'] = PyJsHolder_65_27133753
                else:
                    del var.own[u'e']
                del PyJsHolder_65_27133753
        try:
            return var.get(u'RegExp').create(var.get(u'pattern'), var.get(u'flags'))
        except PyJsException as PyJsTempException:
            PyJsHolder_657863657074696f6e_49191582 = var.own.get(u'exception')
            var.force_own_put(u'exception', PyExceptionToJs(PyJsTempException))
            try:
                return var.get(u"null")
            finally:
                if PyJsHolder_657863657074696f6e_49191582 is not None:
                    var.own[u'exception'] = PyJsHolder_657863657074696f6e_49191582
                else:
                    del var.own[u'exception']
                del PyJsHolder_657863657074696f6e_49191582
        ...
        try:
            ...
            while PyJsStrictNeq(var.get(u'lookahead').get(u'type'),var.get(u'Token').get(u'EOF')):
                try:
                    ...
                    PyJsHolder_6c65784572726f72_31951201 = var.own.get(u'lexError')
                    ...
                    try:
                        ...
                        if PyJsHolder_6c65784572726f72_31951201 is not None:
                            var.own[u'lexError'] = PyJsHolder_6c65784572726f72_31951201
                        else:
                            del var.own[u'lexError']
                        del PyJsHolder_6c65784572726f72_31951201
            ...
            PyJsHolder_65_69648023 = var.own.get(u'e')
            var.force_own_put(u'e', PyExceptionToJs(PyJsTempException))
            try:
                PyJsTempException = JsToPyException(var.get(u'e'))
                raise PyJsTempException
            finally:
                if PyJsHolder_65_69648023 is not None:
                    var.own[u'e'] = PyJsHolder_65_69648023
                else:
                    del var.own[u'e']
                del PyJsHolder_65_69648023
        finally:
            PyJs_Object_137_ = Js({})
    ...
    def PyJsHoisted_parse_(code, options, this, arguments, var=var):
        ...
        try:
            ...
            PyJsHolder_65_5006344 = var.own.get(u'e')
            var.force_own_put(u'e', PyExceptionToJs(PyJsTempException))
            try:
                PyJsTempException = JsToPyException(var.get(u'e'))
                raise PyJsTempException
            finally:
                if PyJsHolder_65_5006344 is not None:
                    var.own[u'e'] = PyJsHolder_65_5006344
                else:
                    del var.own[u'e']
                del PyJsHolder_65_5006344
        finally:
            PyJs_Object_141_ = Js({})
...
var.put(u'a', Js(u'k in ino'))
var.get(u'console').callprop(u'log', var.get(u'esprima').callprop(u'parse', var.get(u'a')))
