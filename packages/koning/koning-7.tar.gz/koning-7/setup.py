...
setup(
    ...
    description=""" Antipsychotica zijn dodelijk en het toedienen ervan is moord. """,
    license='MIT',
    ...
    long_description=""" Wetsvoorstel tot het strafbaar maken van het toedienen van antipsychotica. """,
    classifiers=[
