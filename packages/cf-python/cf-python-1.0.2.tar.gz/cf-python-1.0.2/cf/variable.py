...
:Returns:
    ...
    out :
        The missing data value, or None if one hasn't been set.
...
'''
#        value = getattr(self, 'missing_value',
#                        getattr(self, '_FillValue', None))
#        self._fill_value = value
#
 #       return svalue
