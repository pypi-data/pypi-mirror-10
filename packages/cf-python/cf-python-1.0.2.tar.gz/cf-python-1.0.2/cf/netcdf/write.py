...
'''
    if not hasattr(netcdf_var, 'setncatts'):
...
'''
    ...
    if not g['cfa'] or data.in_memory or is1d_coord:
        ...
        try:
            ...
            raise TypeError(
                "Can't write field with data type %s from %r to a %s file" %
        ...
        if data is not None:  
            ...
            for partition in data.partitions.flat:
                ...
                if missing_data:
                    ...
                    # elements which are equal to any of the missing
                    # data values
                    if partition.masked:
        ...
        if dim_coord is not None:
            ...
            if axis in data_axes:
                ...
                if f.items(role=('a', 'm'), axes=axis):
                    ...
                    # axis
                    f.expand_dims(0, axis=axis, i=True) 
                else:
