#!/usr/bin/python
"""
	This module provides superParser operations and some related functions.

	Functions:

	parser() -- parser the data by the name your give!
	transType() -- it's allow you change some data type for suit for your data-base
...
class akParser:
	...
	def parser(self,delimiter='|',head_retain=True,tail_retain=True):
		"""	This function expect 3 argument,both of the 2,3 are default True
			The first argument is must,and the another depend on whether you
			need and """
