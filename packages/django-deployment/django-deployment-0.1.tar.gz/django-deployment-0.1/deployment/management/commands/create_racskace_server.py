...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        make_option('--account',
            dest='account',
            default=None,
            help='The Racksapce account name'),
        make_option('--api-key',
            dest='api_key',
            default=None,
            help='The Racksapce API key '),
        make_option('--server',
            dest='server',
            default=None,
    ...
    def handle(self, *args, **options):
        ...
        account = options["account"] or get_config('racksapce', 'username')
        api_key = options["api_key"] or get_config('racksapce', 'api_key')
        ...
        # Create the server
        selected_image = options["image"] or get_config('racksapce', 'default_image')
        selected_flavor = options["flavor"] or get_config('racksapce', 'default_flavor')
