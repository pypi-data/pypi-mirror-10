 ...
 */
  __pyx_t_4 = ((struct __pyx_vtabstruct_5thinc_6search_Beam *)__pyx_v_b->__pyx_vtab)->advance(__pyx_v_b, __pyx_f_5tests_13c_test_search_transition, NULL, NULL); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_4 = ((struct __pyx_vtabstruct_5thinc_6search_Beam *)__pyx_v_b->__pyx_vtab)->advance(__pyx_v_b, __pyx_f_5tests_13c_test_search_transition, NULL, NULL); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  __pyx_ptype_5thinc_6search_Beam = __Pyx_ImportType("thinc.search", "Beam", sizeof(struct __pyx_obj_5thinc_6search_Beam), 1); if (unlikely(!__pyx_ptype_5thinc_6search_Beam)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_5thinc_6search_Beam = (struct __pyx_vtabstruct_5thinc_6search_Beam*)__Pyx_GetVtable(__pyx_ptype_5thinc_6search_Beam->tp_dict); if (unlikely(!__pyx_vtabptr_5thinc_6search_Beam)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 38; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_5thinc_6search_MaxViolation = __Pyx_ImportType("thinc.search", "MaxViolation", sizeof(struct __pyx_obj_5thinc_6search_MaxViolation), 1); if (unlikely(!__pyx_ptype_5thinc_6search_MaxViolation)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_5thinc_6search_MaxViolation = (struct __pyx_vtabstruct_5thinc_6search_MaxViolation*)__Pyx_GetVtable(__pyx_ptype_5thinc_6search_MaxViolation->tp_dict); if (unlikely(!__pyx_vtabptr_5thinc_6search_MaxViolation)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
