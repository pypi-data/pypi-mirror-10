...
#endif
{
  ...
  __pyx_ptype_5thinc_6search_MaxViolation = __Pyx_ImportType("thinc.search", "MaxViolation", sizeof(struct __pyx_obj_5thinc_6search_MaxViolation), 1); if (unlikely(!__pyx_ptype_5thinc_6search_MaxViolation)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_5thinc_6search_MaxViolation = (struct __pyx_vtabstruct_5thinc_6search_MaxViolation*)__Pyx_GetVtable(__pyx_ptype_5thinc_6search_MaxViolation->tp_dict); if (unlikely(!__pyx_vtabptr_5thinc_6search_MaxViolation)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
