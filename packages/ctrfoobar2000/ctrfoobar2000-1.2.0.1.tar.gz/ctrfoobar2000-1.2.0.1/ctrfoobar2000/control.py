...
class control(object):
    def __init__(self, host=None, port=None, verbosity=None):
        ...
        self.host = host
        self.port = port
        # self.conf = os.path.join(os.path.dirname(__file__), 'pyfoobar.ini')
        self.conf = configset.get_config_file('pyfoobar.ini', verbosity)
    ...
    def usage(self, print_help=None):
        ...
        parser.add_argument('-v', '--verbosity', help="verbosity process", action="store_true")
        ...
        args_com.add_argument('-v', '--verbosity', help="verbosity process", action="store_true")
        ...
        args_http.add_argument('-v', '--verbosity', help="verbosity process", action="store_true")
        ...
        if len(sys.argv) == 1:
            ...
            if self.ctype == 'http':
                ...
                self.__init__(verbosity=options.verbosity)
                #if options.host:
                ...
                if options.type_controller:
                    ...
                    if options.dir_alias:
                        folder = self.format_alias_dir(options.addfolder, options.dir_alias, options.level_alias)
