...
class Klarna(object):
    ...
    @remote_call
    def extend_expiry_date(self, rno):
        ''' Extends the expiry date on a reservation
        ...
        # Make call
        result = self.xmlrpc.extend_expiry_date(
            self.PROTO, self.VERSION, rno, self.eid, digest
        )
