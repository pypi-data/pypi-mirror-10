...
class Filter(cabc.Mapping):
    ...
    def __del__(self, warnings=warnings, exceptions=exceptions):
        # The module globals may have been cleared before we got called, so
        # hold references to the needed modules
