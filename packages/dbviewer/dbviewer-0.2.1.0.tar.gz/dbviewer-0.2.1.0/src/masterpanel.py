...
class MasterPanel (wx.Panel):
	def __init__(self, parent, showChild=False):
		...
		if showChild:
			...
			self.exitbtn = wx.BitmapButton(self, wx.ID_ANY, bitmap = img1,
			...
			self.hsizer.Add(self.exitbtn, 0, wx.ALL, 5)
	...
	def quitBinder(self, arg):
		return self.Bind(wx.EVT_BUTTON, arg, self.exitbtn)
