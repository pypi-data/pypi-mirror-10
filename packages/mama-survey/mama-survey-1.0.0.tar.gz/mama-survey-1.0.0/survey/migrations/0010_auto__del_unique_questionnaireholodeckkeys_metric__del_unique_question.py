...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'QuestionnaireHolodeckKeys', fields ['questionnaire', 'metric']
        db.delete_unique('survey_questionnaireholodeckkeys', ['questionnaire_id', 'metric'])

        # Removing unique constraint on 'QuestionnaireHolodeckKeys', fields ['metric']
        db.delete_unique('survey_questionnaireholodeckkeys', ['metric'])


    def backwards(self, orm):
        # Adding unique constraint on 'QuestionnaireHolodeckKeys', fields ['metric']
        db.create_unique('survey_questionnaireholodeckkeys', ['metric'])

        # Adding unique constraint on 'QuestionnaireHolodeckKeys', fields ['questionnaire', 'metric']
        db.create_unique('survey_questionnaireholodeckkeys', ['questionnaire_id', 'metric'])
