...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'EUQuizToPost'
        db.delete_table('survey_euquiztopost')

        # Deleting model 'EUNutritionQuiz'
        db.delete_table('survey_eunutritionquiz')

        # Adding model 'ContentQuizToPost'
        db.create_table('survey_contentquiztopost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='post_quiz_set', to=orm['post.Post'])),
            ('quiz', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quiz_post_set', to=orm['survey.ContentQuiz'])),
        ))
        db.send_create_signal('survey', ['ContentQuizToPost'])

        # Adding model 'ContentQuiz'
        db.create_table('survey_contentquiz', (
            ('questionnaire_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.Questionnaire'], unique=True, primary_key=True)),
            ('banner_description', self.gf('django.db.models.fields.TextField')()),
            ('show_on_home_page', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('survey', ['ContentQuiz'])


    def backwards(self, orm):
        # Adding model 'EUQuizToPost'
        db.create_table('survey_euquiztopost', (
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='post_euquiz_set', to=orm['post.Post'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('euquiz', self.gf('django.db.models.fields.related.ForeignKey')(related_name='euquiz_post_set', to=orm['survey.EUNutritionQuiz'])),
        ))
        db.send_create_signal('survey', ['EUQuizToPost'])

        # Adding model 'EUNutritionQuiz'
        db.create_table('survey_eunutritionquiz', (
            ('questionnaire_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.Questionnaire'], unique=True, primary_key=True)),
            ('show_on_home_page', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('banner_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('survey', ['EUNutritionQuiz'])

        # Deleting model 'ContentQuizToPost'
        db.delete_table('survey_contentquiztopost')

        # Deleting model 'ContentQuiz'
        db.delete_table('survey_contentquiz')
