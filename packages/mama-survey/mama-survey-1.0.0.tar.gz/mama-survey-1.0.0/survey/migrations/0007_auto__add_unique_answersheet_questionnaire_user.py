...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AnswerSheet', fields ['questionnaire', 'user']
        db.create_unique('survey_answersheet', ['questionnaire_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AnswerSheet', fields ['questionnaire', 'user']
        db.delete_unique('survey_answersheet', ['questionnaire_id', 'user_id'])
