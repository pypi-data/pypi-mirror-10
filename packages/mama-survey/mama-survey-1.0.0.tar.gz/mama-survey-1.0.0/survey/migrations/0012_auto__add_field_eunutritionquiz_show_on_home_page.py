...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EUNutritionQuiz.show_on_home_page'
        db.add_column('survey_eunutritionquiz', 'show_on_home_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EUNutritionQuiz.show_on_home_page'
        db.delete_column('survey_eunutritionquiz', 'show_on_home_page')
