...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MultiChoiceAnswer', fields ['chosen_option']
        db.delete_unique('survey_multichoiceanswer', ['chosen_option_id'])


        # Changing field 'MultiChoiceAnswer.chosen_option'
        db.alter_column('survey_multichoiceanswer', 'chosen_option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.MultiChoiceOption']))

    def backwards(self, orm):

        # Changing field 'MultiChoiceAnswer.chosen_option'
        db.alter_column('survey_multichoiceanswer', 'chosen_option_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.MultiChoiceOption'], unique=True))
        # Adding unique constraint on 'MultiChoiceAnswer', fields ['chosen_option']
        db.create_unique('survey_multichoiceanswer', ['chosen_option_id'])
