...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EUNutritionQuiz.post'
        db.delete_column('survey_eunutritionquiz', 'post_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EUNutritionQuiz.post'
        db.add_column('survey_eunutritionquiz', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='quiz_post', to=orm['post.Post']),
                      keep_default=False)
    ...
    models = {
        ...
        'survey.eunutritionquiz': {
            'Meta': {'ordering': "('date_created',)", 'object_name': 'EUNutritionQuiz', '_ormbases': ['survey.Questionnaire']},
        ...
        'survey.euquiztopost': {
            'Meta': {'object_name': 'EUQuizToPost'},
            'euquiz': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'euquiz_post_set'", 'to': "orm['survey.EUNutritionQuiz']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'post_euquiz_set'", 'to': "orm['post.Post']"})
        },
