...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionnaireHolodeckKeys'
        db.create_table('survey_questionnaireholodeckkeys', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('questionnaire', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Questionnaire'])),
            ('metric', self.gf('django.db.models.fields.PositiveSmallIntegerField')(unique=True)),
            ('holodeck_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('survey', ['QuestionnaireHolodeckKeys'])


    def backwards(self, orm):
        # Deleting model 'QuestionnaireHolodeckKeys'
        db.delete_table('survey_questionnaireholodeckkeys')
    ...
    models = {
        ...
        'survey.questionnaireholodeckkeys': {
            'Meta': {'object_name': 'QuestionnaireHolodeckKeys'},
            'holodeck_key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metric': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True'}),
            'questionnaire': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.Questionnaire']"})
        }
    }
