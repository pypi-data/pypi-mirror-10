...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AnswerSheet.user'
        db.alter_column('survey_answersheet', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'AnswerSheet', fields ['user']
        db.create_unique('survey_answersheet', ['user_id'])
