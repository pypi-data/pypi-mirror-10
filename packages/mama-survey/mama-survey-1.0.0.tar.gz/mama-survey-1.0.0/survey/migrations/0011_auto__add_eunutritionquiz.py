...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('survey_eunutritionquiz', (
            ...
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quiz_post', to=orm['post.Post'])),
    ...
    models = {
        ...
        'survey.eunutritionquiz': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quiz_post'", 'to': "orm['post.Post']"}),
