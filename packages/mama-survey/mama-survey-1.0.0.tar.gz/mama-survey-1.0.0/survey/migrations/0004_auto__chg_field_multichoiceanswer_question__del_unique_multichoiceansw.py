...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MultiChoiceAnswer', fields ['question']
        db.delete_unique('survey_multichoiceanswer', ['question_id'])


        # Changing field 'MultiChoiceAnswer.question'
        db.alter_column('survey_multichoiceanswer', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.MultiChoiceQuestion']))

    def backwards(self, orm):

        # Changing field 'MultiChoiceAnswer.question'
        db.alter_column('survey_multichoiceanswer', 'question_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.MultiChoiceQuestion'], unique=True))
        # Adding unique constraint on 'MultiChoiceAnswer', fields ['question']
        db.create_unique('survey_multichoiceanswer', ['question_id'])
