...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MultiChoiceAnswer', fields ['answer_sheet']
        db.delete_unique('survey_multichoiceanswer', ['answer_sheet_id'])


        # Changing field 'MultiChoiceAnswer.answer_sheet'
        db.alter_column('survey_multichoiceanswer', 'answer_sheet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.AnswerSheet']))

    def backwards(self, orm):

        # Changing field 'MultiChoiceAnswer.answer_sheet'
        db.alter_column('survey_multichoiceanswer', 'answer_sheet_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.AnswerSheet'], unique=True))
        # Adding unique constraint on 'MultiChoiceAnswer', fields ['answer_sheet']
        db.create_unique('survey_multichoiceanswer', ['answer_sheet_id'])
