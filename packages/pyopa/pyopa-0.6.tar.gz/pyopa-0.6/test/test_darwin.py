...
class AlignTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(os.path.join('test', 'data', 'testseqs.txt')) as f:
        ...
        with open(os.path.join('test','data', 'reference_test_results.dat')) as f:
            #skip header
            next(f)
    ...
    def _align_t(self):
        ...
        for r in self.darwin_results:
            ...
            if r.als1 != '':
                ...
                print(r.s1_id, r.s2_id)
                print(str(aligned_strings[0]), str(aligned_strings[1]))
                print(ep_result)
