# Copyright 2013-2015 Juca Crispim <juca# Copyright 2013>
...
class RestHandler(ModelHandler):
    ...
    def set_default_headers(self):
        if hasattr(self, 'cors_origins') and self.cors_origins:
            self.set_header('Access-Control-Allow-Origin', self.cors_origins)
    ...
    def get(self, operation):
        ...
        method_to_call = self._validade_operation(operation,
                                                  allowed_operations)
        yield self.call_method_and_write_json(method_to_call)
    ...
    def call_method_and_write_json(self, method_to_call):
        ...
        returned_obj = yield method_to_call(**self.params)
    ...
    def get_object(self, **kwargs):
        ...
        """
        obj = yield self.model.objects.get(**kwargs)
        return obj
    ...
    def delete_object(self, **kwargs):
        ...
        """
        obj = yield self.get_object(**kwargs)
        yield obj.delete()
