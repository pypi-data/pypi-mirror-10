...
# and table 9-5 of the USB 3.0 specifications
...
class libusb_ss_endpoint_companion_descriptor(Structure):
    _fields_ = [('bLength', c_uint8),
                ('bDescriptorType', c_uint8),
                ('bMaxBurst', c_uint8),
                ('bmAttributes', c_uint8),
                ('wBytesPerInterval', c_uint16)]
libusb_ss_endpoint_companion_descriptor_p = POINTER(
    libusb_ss_endpoint_companion_descriptor)

class libusb_bos_dev_capability_descriptor(Structure):
    _fields_ = [('bLength', c_uint8),
                ('bDescriptorType', c_uint8),
                ('bDevCapabilityType', c_uint8)]
libusb_bos_dev_capability_descriptor_p = POINTER(
  libusb_bos_dev_capability_descriptor)

class libusb_bos_descriptor(Structure):
    _fields_ = [('bLength', c_uint8),
                ('bDescriptorType', c_uint8),
                ('wTotalLength', c_uint16),
                ('bNumDeviceCaps', c_uint8),
                ('dev_capability',
                    POINTER(libusb_bos_dev_capability_descriptor_p))]
libusb_bos_descriptor_p = POINTER(libusb_bos_descriptor)

class libusb_usb_2_0_extension_descriptor(Structure):
    _fields_ = [('bLength', c_uint8),
                ('bDescriptorType', c_uint8),
                ('bDevCapabilityType', c_uint8),
                ('bmAttributes', c_uint32)]
libusb_usb_2_0_extension_descriptor_p = POINTER(
  libusb_usb_2_0_extension_descriptor)

class libusb_ss_usb_device_capability_descriptor(Structure):
    _fields_ = [('bLength', c_uint8),
                ('bDescriptorType', c_uint8),
                ('bDevCapabilityType', c_uint8),
                ('bmAttributes', c_uint8),
                ('wSpeedSupported', c_uint16),
                ('bFunctionalitySupport', c_uint8),
                ('bU1devExitLat', c_uint8),
                ('bU2DevExitLat', c_uint16)]
libusb_ss_usb_device_capability_descriptor_p = POINTER(
  libusb_ss_usb_device_capability_descriptor)

class libusb_container_id_descriptor(Structure):
    _fields_ = [('bLength', c_uint8),
                ('bDescriptorType', c_uint8),
                ('bDevCapabilityType', c_uint8),
                ('bReserved', c_uint8),
                ('ContainerId', c_uint8 * 16)]
libusb_container_id_descriptor_p = POINTER(
...
try:
    ...
    libusb_get_ss_endpoint_companion_descriptor = libusb.libusb_get_ss_endpoint_companion_descriptor
except AttributeError:
    def libusb_free_ss_endpoint_companion_descriptor(_):
        pass
else:
    libusb_get_ss_endpoint_companion_descriptor.argtypes = [libusb_context_p,
        libusb_endpoint_descriptor_p,
        POINTER(libusb_ss_endpoint_companion_descriptor_p)]
    libusb_get_ss_endpoint_companion_descriptor.restype = c_int
    #void libusb_free_ss_endpoint_companion_descriptor(
    #       struct libusb_ss_endpoint_companion_descriptor *ep_comp);
    libusb_free_ss_endpoint_companion_descriptor = \
        libusb.libusb_free_ss_endpoint_companion_descriptor
    libusb_free_ss_endpoint_companion_descriptor.argtypes = [
        libusb_ss_endpoint_companion_descriptor_p]
    libusb_free_ss_endpoint_companion_descriptor.restype = None
try:
    #int libusb_get_bos_descriptor(libusb_device_handle *handle,
    #       struct libusb_bos_descriptor **bos);
    libusb_get_bos_descriptor = libusb.libusb_get_bos_descriptor
except AttributeError:
    def libusb_free_bos_descriptor(_):
        pass
else:
    libusb_get_bos_descriptor.argtypes = [libusb_device_handle_p,
        POINTER(libusb_bos_descriptor_p)]
    libusb_get_bos_descriptor.restype = c_int
    #void libusb_free_bos_descriptor(struct libusb_bos_descriptor *bos);
    libusb_free_bos_descriptor = libusb.libusb_free_bos_descriptor
    libusb_free_bos_descriptor.argtypes = [libusb_bos_descriptor_p]
...
try:
    ...
    libusb_get_usb_2_0_extension_descriptor = \
        libusb.libusb_get_usb_2_0_extension_descriptor
except AttributeError:
    def libusb_free_usb_2_0_extension_descriptor(_):
        pass
else:
    libusb_get_usb_2_0_extension_descriptor.argtypes = [libusb_context_p,
        libusb_bos_dev_capability_descriptor_p,
        POINTER(libusb_usb_2_0_extension_descriptor_p)]
    libusb_get_usb_2_0_extension_descriptor.restype = c_int
    #void libusb_free_usb_2_0_extension_descriptor(
    #       struct libusb_usb_2_0_extension_descriptor *usb_2_0_extension);
    libusb_free_usb_2_0_extension_descriptor = \
        libusb.libusb_free_usb_2_0_extension_descriptor
    libusb_free_usb_2_0_extension_descriptor.argtypes = [
        libusb_usb_2_0_extension_descriptor_p]
...
try:
    ...
    libusb_get_ss_usb_device_capability_descriptor = \
        libusb.libusb_get_ss_usb_device_capability_descriptor
except AttributeError:
    def libusb_free_ss_usb_device_capability_descriptor(_):
        pass
else:
    libusb_get_ss_usb_device_capability_descriptor.argtypes = [
        libusb_context_p,
        libusb_bos_dev_capability_descriptor_p,
        POINTER(libusb_ss_usb_device_capability_descriptor_p)]
    ...
    libusb_free_ss_usb_device_capability_descriptor = \
        libusb.libusb_free_ss_usb_device_capability_descriptor
    libusb_free_ss_usb_device_capability_descriptor.argtypes = [
        libusb_ss_usb_device_capability_descriptor_p]
...
try:
    ...
    libusb_get_container_id_descriptor = \
        libusb.libusb_get_container_id_descriptor
except AttributeError:
    def libusb_free_container_id_descriptor(_):
        pass
else:
    libusb_get_container_id_descriptor.argtypes = [libusb_context_p,
        libusb_bos_dev_capability_descriptor_p,
        POINTER(libusb_container_id_descriptor_p)]
    libusb_get_container_id_descriptor.restype = c_int
    #void libusb_free_container_id_descriptor(
    #       struct libusb_container_id_descriptor *container_id);
    libusb_free_container_id_descriptor = \
        libusb.libusb_free_container_id_descriptor
    libusb_free_container_id_descriptor.argtypes = [
        libusb_container_id_descriptor_p]
