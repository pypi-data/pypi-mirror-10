...
class RoleTests(IdentityTests):
    ...
    def test_role_create(self):
        ...
        self.addCleanup(self.openstack, 'role delete %s' % role_name)
    ...
    def test_role_list_with_user_and_project(self):
        role_name = self._create_dummy_role()
        username = self._create_dummy_user()
        raw_output = self.openstack(
            'role add '
            '--project %(project)s --project-domain %(project_domain)s '
            '--user %(user)s --user-domain %(user_domain)s '
