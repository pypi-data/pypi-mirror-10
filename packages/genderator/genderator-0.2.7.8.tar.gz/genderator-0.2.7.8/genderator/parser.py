    ...
    def guess_gender(self, fullname):
        ...
        if isinstance(fullname, str):
            if self.__normalize:
                ...
                fullname = self.__normalizr.replace_symbols(fullname, 'NFKC',
                                                            self.__normalizr_exclusions,replacement=' ')
                fullname = self.__normalizr.replace_punctuation(fullname, excluded=set('\''), replacement=' ').lower()
