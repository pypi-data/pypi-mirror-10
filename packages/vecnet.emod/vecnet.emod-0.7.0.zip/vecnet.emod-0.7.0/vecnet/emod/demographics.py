...
if __name__ == "__main__":
    ...
    print decompile_demographics("tests\\demographics\\tb_vital_dynamics_test_complex_demographics.compiled.json")
    print decompile_demographics("tests\\demographics\\demographics.compiled.json")
    print decompile_demographics(os.path.join("tests", "demographics", "solomons", "Honiara_Haleta_two_node_demographics.compiled.json"))
