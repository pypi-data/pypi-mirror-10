...
def configdict(cfgfname, args):
    ...
    if cfgfname is not None:
        ...
        cfgdict['space'] = config.get('Content', 'space')[1:-1]
        cfgdict['burnin'] = config.getint('Experiment', 'burnin')
        cfgdict['maxtemp'] = config.getfloat('Experiment', 'max-temp')
        cfgdict['topics'] = config.getint('Model', 'topics')
        ...
        cfgdict['alpha'] = config.getfloat('Hyperparameters', 'alpha')
        cfgdict['theta'] = config.getfloat('Hyperparameters', 'theta')
        ...
        cfgdict['beamsize'] = config.getint('Experiment', 'beamsize')
        ...
        cfgdict['lda'] = defaults['LDA']
        cfgdict['dictfname'] = defaults['word-dict']
        cfgdict['atomfname'] = defaults['atom-dict']
        cfgdict['alpha'] = defaults['alpha']
        cfgdict['theta'] = defaults['theta']
        cfgdict['pstop'] = defaults['pstop']
        cfgdict['fwdbwd'] = defaults['fwdbwd']
        cfgdict['hparamsmp'] = defaults['hparamsmp']
        cfgdict['poisson'] = defaults['poisson']
        cfgdict['verbose'] = defaults['verbose']
        cfgdict['debug'] = defaults['debug']
        cfgdict['cache'] = defaults['cache']
...
parser.add_argument(
    ...
    help='Blank space [default=\' \']', default=' '
)
parser.add_argument(
