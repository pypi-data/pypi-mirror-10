...
#                                print_to_file=print_to_file, print_filename=print_filename)
    ...
    @staticmethod
    def fill_subplot_twinx(ax, x, y, x_label='x', y_label=('y1', 'y2'),
    ...
    def fill_subplot(ax, x, y, x_label='x', y_label='y',
                     style='b-', line_desc='l1'):

        ax.plot(x, y, style, label=line_desc)
    ...
    def plot_stats(self):
        ...
        self.fill_subplot_twinx(ax[0, 0], self.stats['itime'], (self.stats['nprobe_el'], self.stats['nprobe_ari']),
                                x_label = '# output', y_label=('probe el', 'probe ion'),
                                style=('r-', 'g-'), line_desc=('el', 'ion'))

        self.fill_subplot_twinx(ax[1, 0], self.stats['itime'], (self.stats['nnew_el'], self.stats['nnew_ari']),
                                x_label = '# output', y_label=('new el', 'new ion'),
                                style=('r-', 'g-'), line_desc=('el', 'ion'))

        self.fill_subplot_twinx(ax[2, 0], self.stats['itime'], (self.stats['nsheath_el'], self.stats['nsheath_ari']),
        ...
        self.fill_subplot_twinx(ax[1, 1], self.stats['itime'], (self.stats['nactive_el'], self.stats['nactive_ari']),
    ...
    def plot_averaged_profiles(self, ts_from=1, ts_to=-1, plot_n0=True):
        """
        ...
        if plot_n0:
            ax[0, 0].plot([self.params[0]['r_p'], self.params[0]['r_d']], [self.params[0]['n_e'], self.params[0]['n_e']], 'b--', label='n0')

        self.fill_subplot(ax[0, 0], r, ne, x_label = 'r [m]', y_label='ne, ni [m^-3]',
                          style='r-', line_desc='ne')
        self.fill_subplot(ax[0, 0], r, ni, x_label = 'r [m]', y_label='ne, ni [m^-3]',
                          style='g-', line_desc='ni')

        self.fill_subplot_twinx(ax[1, 0], r, (phi,er),
                                x_label = 'r [m]', y_label=('phi [V]', 'er [V/m]'),
                                style=('b-', 'r-'), line_desc=('phi', 'er'))

        self.fill_subplot_twinx(ax[0, 1], r, (Te, vre),
                                x_label = 'r [m]', y_label=('Te', 'vre'),
                                style=('r-', 'r--'), line_desc=('Te', 'vre'))

        self.fill_subplot_twinx(ax[1, 1], r, (Ti, vri),
                                x_label = 'r [m]', y_label=('Ti', 'vri'),
                                style=('g-', 'g--'), line_desc=('Ti', 'vri'))
