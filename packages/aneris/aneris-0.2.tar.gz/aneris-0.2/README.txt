...
TODO: add top level executable to package. Currently you have to faff around chmodding the installed aneris.py and then adding a symlink to it somewhere sensible, like /usr/local/bin.
