	...
	while True:
		...
		if key == curses.KEY_UP:
			...
			try:
				...
				stdscr.addstr(13, 1, "page up      : increment project priority/task hours/hours committed", curses.A_BOLD|curses.color_pair(5))
				stdscr.addstr(14, 1, "page down    : decrement project priority/task hours/hours committed", curses.A_BOLD|curses.color_pair(5))
