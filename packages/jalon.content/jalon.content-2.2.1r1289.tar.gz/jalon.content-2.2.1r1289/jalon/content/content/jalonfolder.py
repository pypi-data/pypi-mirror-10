...
class JalonFolder(ATFolder):
    ...
    def getListeEtudiantsXLS(self, cod_etp):
        ...
        feuil1.write(0, 3, "Courriel", styleEnTete)
        ...
        for etudiant in listeEtudiants:
            ...
            ligne1.write(3, etudiant["EMAIL_ETU"])
            i = i + 1
    ...
    def getInfosJalonConfiguration(self, info):
        u"""recupère differents éléments génériques defini par l'administrateur dans les configs Jalon."""
