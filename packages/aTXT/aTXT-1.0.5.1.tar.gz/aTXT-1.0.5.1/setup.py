...
setup(
    ...
    install_requires=['binaryornot==0.3.0', 'chardet==2.3.0', 'colorlog==2.6.0', 'colorama==0.3.3', 'docopt==0.6.2', 'docx==0.2.4', 'funcy==1.5', 'html2text==2015.2.18', 'Jinja2==2.7.3', 'kitchen==1.2.1', 'lxml==3.4.2',
