...
from onyx.database.ufo_base import UfoBase, get_base_classes
...
class UseGraph(object):
    ...
    def __enter__(self):
        # --- here we replace the cache of the database client with the cache
        #     of the graph itself
        self.graph.objects.update(onyx_db.obj_clt.cache)
        onyx_db.obj_clt.cache = self.graph.objects
