...
def _register(app):
    def setup_config(app):
        if app.config.get("APP_NAME"):
            Pylot.set_context__(APP_NAME=app.config.get("APP_NAME"))
        if app.config.get("APP_VERSION"):
            Pylot.set_context__(APP_VERSION=app.config.get("APP_VERSION"))
        ...
        if app.config.get("LOGIN_OAUTH_ENABLE"):
            ...
            Pylot.set_context__(LOGIN_OAUTH_ENABLED=True,
    ...
    def register_static():
        ...
        env.register(
            'pylot_js',
            Bundle(
                "pylot/vendor/authomatic/authomatic.js",
