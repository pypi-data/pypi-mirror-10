...
pkginfo = read_pkginfo('./portfolio/pkginfo.py')

__NAME__ = "Portfolio-py"
__version__ = "0.0.1"
...
setup(
    ...
    description="Portfolio is a Flask based framework that adds structure and map your views and templates together for rapid application development",
    long_description=__doc__,
    url='https://github.com/mardix/portfolio/',
    download_url='http://github.com/mardix/portfolio/tarball/master',
    py_modules=['portfolio'],
    entry_points=dict(console_scripts=[
        'portfolio=portfolio.cmd:main'
    ]),
