...
class AllFeed(Feed):
    ...
    title = conf.RBLOG_SITE_TITLE
    link = "/"
    description = conf.RBLOG_SITE_DESCRIPTION
...
class TagFeed(Feed):
    ...
    def items(self, obj):
        # https://django-taggit.readthedocs.org/en/latest/api.html#filtering
        myposts = Post.objects.filter(tags__slug=obj.slug)
