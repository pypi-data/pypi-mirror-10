...
from rmixins.mixins import expire_view_cache
...
class PostAdminForm(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        expire_view_cache('rblog:index', fake_metas)
        expire_view_cache('rblog:ajaxarchive', fake_metas)
        expire_view_cache('rblog:post_detail', fake_metas, [obj.slug])
        if not change:
    ...
    def temp_view(self, obj):
        uri = reverse('rblog:post_detail_temp', args=(obj.slug,))
