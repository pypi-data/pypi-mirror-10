...
class Post(models.Model):
    ...
    redirect = models.URLField(_(u'Redirect'), max_length=255, blank=True,
                               null=True,
                               help_text=_('Redirect the post to this url'))
    ...
    def get_absolute_url(self):
        return reverse('rblog:post_detail', kwargs={'slug': self.slug})
