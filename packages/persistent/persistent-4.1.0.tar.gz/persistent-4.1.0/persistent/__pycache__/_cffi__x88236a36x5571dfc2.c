...
static PyObject *
_cffi_f_ring_add(PyObject *self, PyObject *args)
{
  CPersistentRing * x0;
  CPersistentRing * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_ParseTuple(args, "OO:ring_add", &arg0, &arg1))
    return NULL;
...
static PyObject *
_cffi_f_ring_del(PyObject *self, PyObject *arg0)
{
  CPersistentRing * x0;
  Py_ssize_t datasize;
...
static PyObject *
_cffi_f_ring_move_to_head(PyObject *self, PyObject *args)
{
  CPersistentRing * x0;
  CPersistentRing * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_ParseTuple(args, "OO:ring_move_to_head", &arg0, &arg1))
    return NULL;
...
static PyObject *
_cffi_layout_struct_CPersistentRing_struct(PyObject *self, PyObject *noarg)
{
...
static PyMethodDef _cffi_methods[] = {
  {"ring_add", _cffi_f_ring_add, METH_VARARGS, NULL},
  {"ring_del", _cffi_f_ring_del, METH_O, NULL},
  {"ring_move_to_head", _cffi_f_ring_move_to_head, METH_VARARGS, NULL},
  {"_cffi_layout_struct_CPersistentRing_struct", _cffi_layout_struct_CPersistentRing_struct, METH_NOARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x88236a36x5571dfc2(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x88236a36x5571dfc2(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x88236a36x5571dfc2", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
