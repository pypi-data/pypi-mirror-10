...
setup(
    name='planarradpy',
    version='0.0.1-6',
    packages=['planarradpy', 'planarradpy.gui', 'planarradpy.log', 'planarradpy.docs', 'planarradpy.tests', 'planarradpy.inputs',
    ...
    install_requires=['PyQt4', 'numpy', 'scipy', 'matplotlib'],
)
