...
class IRCBot(object):
    ...
    def start_up(self):
        ...
        while True:
            ...
            if self.handle_ping(block):
                ...
                logging.debug("[Set USER and NICK]")
    ...
    def send_message(self, message, send_to=None):
        ...
        logging.info("[{} {} {}] {}".format(self.nick, "on" if send_to == self.channel else "to", send_to, message))
    ...
    def handle_block(self, block):
        ...
        if command.upper() in ("PRIVMSG", "ALERT"):
            logging.info("[{} {} {}] {}".format(sender, "on" if recipient == self.channel else "to", recipient, message))
        if sender.lower() == "nickserv":
            ...
            if clear_message == "your nick isnt registered":
                ...
                logging.debug("[Registered Nickname]")
    ...
    def leave_channel(self, message=None):
        logging.debug("[Left Channel {} with reason '{}']".format(self.channel, message))
