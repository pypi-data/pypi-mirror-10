...
task_names_dictionary = {
                         ...
                         'simulation': 'update_simulation_log',
                         'execution': 'update_execution_log',
                         'status': 'update_execution_status',
                         'spawning': 'update_machine_spawning_time',
}

args_names_dictionary = {
                         'create_task': ['app_type', 'input_file', 'output_file', 'hgs_version', 'debug'],
                         'delete_task': [],
                         'retrieve_output': [],
