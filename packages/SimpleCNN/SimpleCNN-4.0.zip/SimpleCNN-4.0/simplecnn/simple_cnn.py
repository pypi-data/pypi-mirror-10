...
class SimpleCNN(object):
    ...
    def __init__(self, data_path, input_dim, output_dim, layers, mini_batch_size, epoch):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Create a simple convolutional neural network.',
                                     ...
                                     "python simple_cnn.py 784 10 C(1,9,20)-P(2)-S 300 3 ../../data/")
    ...
    parser.add_argument('data_path', metavar='data_path', type=str, nargs='?', 
                        default='../../data/', help="The path containing the four train and test data and label files from LeCunn's website: " + 
    ...
    simple_cnn = SimpleCNN(data_path, input_dim, output_dim, layers, mini_batch_size, epoch)  
    simple_cnn.train()
