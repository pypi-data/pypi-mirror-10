...
# import potentially inexistant file
try:
    from .photobackup_settings import MEDIA_ROOT, PASSWORD, PORT
except ImportError:
    sys.exit("Settings file no created, please run 'photobackup init'")
...
def index():
    ...
    return template(os.path.join(here, 'index.html'))
