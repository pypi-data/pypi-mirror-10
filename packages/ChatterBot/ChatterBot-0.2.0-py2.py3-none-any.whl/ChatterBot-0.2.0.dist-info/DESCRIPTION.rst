...
**Note:** \*The ``ChatBot`` requires that a name is specified for the
bot.
...
An optional parameter ``database`` can be used to change the default
database path. The default database path is 'database.db'.\*
...
+-----------------------------------------------------------------+----------------------------------+
| `Salvius the Robot <https://github.com/gunthercox/salvius>`__   | A humanoid robot.                |
+=================================================================+==================================+
| `Zuluhotel <http://zuluhotel3.com>`__                           | A mmorpg shard emulation game.   |
+-----------------------------------------------------------------+----------------------------------+
