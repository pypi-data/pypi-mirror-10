...
def get_pointer(self):
    ...
    :class:`~pywayland.protocol.pointer.Pointer` interface for this seat.
...
def get_keyboard(self):
    ...
    The ID provided will be initialized to the
    :class:`~pywayland.protocol.keyboard.Keyboard` interface for this seat.
...
def get_touch(self):
    ...
    The ID provided will be initialized to the
    :class:`~pywayland.protocol.touch.Touch` interface for this seat.
