...
class ShellSurface(Interface):
    ...
    :class:`~pywayland.protocol.surface.Surface`, for implementations that
    ...
    :class:`~pywayland.protocol.surface.Surface` is destroyed.  On client side,
    :class:`~pywayland.protocol.shellsurfacedestroy.ShellSurfaceDestroy`() must
    be called before destroying the
    :class:`~pywayland.protocol.surface.Surface` object.
    """
