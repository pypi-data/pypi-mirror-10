...
DEFAULT_CHARM_URLS = collections.OrderedDict((
    ('precise', 'cs:precise/juju-gui-117'),
    ('trusty', 'cs:trusty/juju-gui-32'),
))
...
# The minimum Juju GUI charm revision supporting uncommitted bundle
# deployments. Assume not listed series to always support uncommitted state.
MINIMUM_REVISIONS_FOR_UNCOMMITTED_BUNDLES = collections.defaultdict(
    lambda: 0, {'precise': 115, 'trusty': 28})
