...
def get_range(out_radius=25, cutoff=(0, 0, 0, 0, 0, 0)):
    """
...
def get_precision():
    """
    center that will determine the size of dipole.
    :return: int
    """
    return 2
...
def get_dipole():
    """
    get the dipole size depending the precision
    :return: float
    """
    precision = get_precision()
    return 0.001/float(precision)
