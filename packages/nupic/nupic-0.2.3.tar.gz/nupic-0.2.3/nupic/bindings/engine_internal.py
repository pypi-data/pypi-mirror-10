...
class Network(object):
    ...
    def registerRegionPackage(*args, **kwargs):
        """registerRegionPackage(path)"""
        return _engine_internal.Network_registerRegionPackage(*args, **kwargs)

    registerRegionPackage = staticmethod(registerRegionPackage)
Network_swigregister = _engine_internal.Network_swigregister
Network_swigregister(Network)

def Network_registerRegionPackage(*args, **kwargs):
  """Network_registerRegionPackage(path)"""
  return _engine_internal.Network_registerRegionPackage(*args, **kwargs)
...
class Region(object):
    ...
    def registerRegionPackage(*args, **kwargs):
        """registerRegionPackage(path)"""
        return _engine_internal.Region_registerRegionPackage(*args, **kwargs)
...
def Region_registerRegionPackage(*args, **kwargs):
  """Region_registerRegionPackage(path)"""
  return _engine_internal.Region_registerRegionPackage(*args, **kwargs)
