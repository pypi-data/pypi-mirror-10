...
.. figure:: media/logos/logotype-blacktext-transparentbg.png
   :alt: Hypatia 0.2

   Hypatia 0.2

|GitHub license| |PyPI| |Travis| |Coveralls| |Code Climate| |PyPI|
|Gratipay| |Bountysource| |Donate with Paypal| |Donate with Patreon| |My
Amazon Wishlist|
...
`The included demo game <#quick-demo>`__ (``demo/game.py``) in action:
...
A labor of love, `permissively (MIT) licensed <license.txt>`__, and
crafted by `Lillian
...
`The included demo <#quick-demo>`__ allows you to mess with all of its
resources (see the ``resources`` directory!). With it you can:
...
.. |PyPI| image:: https://img.shields.io/pypi/v/hypatia_engine.svg?style=flat-square
...
.. |PyPI| image:: https://img.shields.io/pypi/dm/hypatia_engine.svg?style=flat-square
   :target: https://pypi.python.org/pypi/hypatia_engine/
