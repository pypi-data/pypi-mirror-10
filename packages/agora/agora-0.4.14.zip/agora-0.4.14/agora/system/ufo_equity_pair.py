...
class EquityPair(UfoBase):
    ...
    # -------------------------------------------------------------------------
    def fit_spread_parms(self, min_range=None, max_range=None):
        """
        Description:
            Determine the longest regression range that allows to reject the
    ...
    # -------------------------------------------------------------------------
    def set_spread_parms(self):
        parms = self.fit_spread_parms()
        self.Alpha = parms["c"]
        self.Beta = parms["m"]
        self.RegRange = parms["rule"]
