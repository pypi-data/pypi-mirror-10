...
from onyx.core import (LYY2Date, Knot, DelObj, UpdateObj, Transaction,
                       GetVal, SetVal, TsDbGetCurve, TsDbQuery, GraphNodeVt,
                       StringField, DictField, ReferenceField)
...
REPLACE = set.union(Asset._json_fields, {"Market", "CntType", "ContractSize",
                                         "SettDateRule", "OptExpDateRule"})
...
def prepare_for_test():
    ...
    prc_fix.add_dated("Price", Date.today(), 7.0)
