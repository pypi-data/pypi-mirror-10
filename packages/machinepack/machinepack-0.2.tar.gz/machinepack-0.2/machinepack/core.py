...
class MachinePackViewer(MachinePackManager):
    ...
    def get_source(self, machine):
        return open('%s/%s.py' % (self.machinepack_name, machine)).read()
    ...
    def generate_example(self, machine_name):
        ...
        params = {
            'machinepack_name': self.machinepack_name,
    ...
    def create_basic_structure(self, params):
        ...
        paths = {
            top_level_path: {
                ...
                "machinepack_config.py": ('config.mako', params),
                "MANIFEST.in": ('MANIFEST.in.mako', {}),
            },
            module_path: {
    ...
    def make_tests(self, machine_name=None, coverage=True):
        ...
        for machine_name in machines_list:
            tests = importlib.import_module('%s.%s_test' % (self.machinepack_name, machine_name)).tests
