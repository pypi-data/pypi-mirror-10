...
const pb_field_t AllTypes_fields[60] = {
    ...
    PB_FIELD( 17, ENUM    , REQUIRED, POINTER , OTHER, AllTypes, req_enum, req_submsg, 0),
    PB_FIELD( 18, MESSAGE , REQUIRED, POINTER , OTHER, AllTypes, req_emptymsg, req_enum, &EmptyMessage_fields),
    PB_FIELD( 21, INT32   , REPEATED, POINTER , OTHER, AllTypes, rep_int32, req_emptymsg, 0),
    ...
    PB_FIELD( 37, ENUM    , REPEATED, POINTER , OTHER, AllTypes, rep_enum, rep_submsg, 0),
    PB_FIELD( 38, MESSAGE , REPEATED, POINTER , OTHER, AllTypes, rep_emptymsg, rep_enum, &EmptyMessage_fields),
    PB_FIELD( 41, INT32   , OPTIONAL, POINTER , OTHER, AllTypes, opt_int32, rep_emptymsg, &AllTypes_opt_int32_default),
    ...
    PB_FIELD( 57, ENUM    , OPTIONAL, POINTER , OTHER, AllTypes, opt_enum, opt_submsg, &AllTypes_opt_enum_default),
    PB_FIELD( 58, MESSAGE , OPTIONAL, POINTER , OTHER, AllTypes, opt_emptymsg, opt_enum, &EmptyMessage_fields),
    PB_ONEOF_FIELD(oneof,  59, MESSAGE , ONEOF, POINTER , OTHER, AllTypes, oneof_msg1, opt_emptymsg, &SubMessage_fields),
    PB_ONEOF_FIELD(oneof,  60, MESSAGE , ONEOF, POINTER , OTHER, AllTypes, oneof_msg2, opt_emptymsg, &EmptyMessage_fields),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(AllTypes, oneof.oneof_msg2) < 65536 && pb_membersize(AllTypes, req_submsg) < 65536 && pb_membersize(AllTypes, req_emptymsg) < 65536 && pb_membersize(AllTypes, rep_submsg) < 65536 && pb_membersize(AllTypes, rep_emptymsg) < 65536 && pb_membersize(AllTypes, opt_submsg) < 65536 && pb_membersize(AllTypes, opt_emptymsg) < 65536 && pb_membersize(AllTypes, req_limits) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_SubMessage_EmptyMessage_Limits_AllTypes)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(AllTypes, oneof.oneof_msg2) < 256 && pb_membersize(AllTypes, req_submsg) < 256 && pb_membersize(AllTypes, req_emptymsg) < 256 && pb_membersize(AllTypes, rep_submsg) < 256 && pb_membersize(AllTypes, rep_emptymsg) < 256 && pb_membersize(AllTypes, opt_submsg) < 256 && pb_membersize(AllTypes, opt_emptymsg) < 256 && pb_membersize(AllTypes, req_limits) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_SubMessage_EmptyMessage_Limits_AllTypes)
#endif
