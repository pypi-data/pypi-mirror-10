...
const pb_field_t AllTypes_fields[60] = {
    ...
    PB_FIELD( 41, INT32   , OPTIONAL, STATIC  , OTHER, AllTypes, opt_int32, rep_emptymsg, &AllTypes_opt_int32_default),
    ...
    PB_ONEOF_FIELD(oneof,  59, MESSAGE , ONEOF, STATIC  , OTHER, AllTypes, oneof_msg1, opt_emptymsg, &SubMessage_fields),
    PB_ONEOF_FIELD(oneof,  60, MESSAGE , ONEOF, STATIC  , OTHER, AllTypes, oneof_msg2, opt_emptymsg, &EmptyMessage_fields),
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(AllTypes, oneof.oneof_msg2) < 256 && pb_membersize(AllTypes, req_submsg) < 256 && pb_membersize(AllTypes, req_emptymsg) < 256 && pb_membersize(AllTypes, rep_submsg[0]) < 256 && pb_membersize(AllTypes, rep_emptymsg[0]) < 256 && pb_membersize(AllTypes, opt_submsg) < 256 && pb_membersize(AllTypes, opt_emptymsg) < 256 && pb_membersize(AllTypes, req_limits) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_SubMessage_EmptyMessage_Limits_AllTypes)
#endif
