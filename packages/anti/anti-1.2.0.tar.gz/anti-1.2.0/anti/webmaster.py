...
from .utils import get_normal_url, get_or_create, transaction
...
class Wrapper(object):
    ...
    def auth(self):
        """ Авторизация """
        self.user = self.user # 'avro7777'
        self.passwd = self.passwd # 'b67d0ee47e'
        self.client_secret = self.client_secret # '403779a4409144feba99f5e148cbaa9f'
        self.client_id = self.client_id # '9e9c18109e014bb8b24f23f702cf4181'
    ...
    def get_url(self):
        ...
        resp = requests.get('https://webmaster.yandex.ru/api/v2/hosts', headers = self.headers)
        soup = BeautifulSoup(resp.text)
...
class Webmaster(Wrapper):
    ...
    def get_tic(self):
        ...
        rsst = requests.get(url, headers = self.headers)
