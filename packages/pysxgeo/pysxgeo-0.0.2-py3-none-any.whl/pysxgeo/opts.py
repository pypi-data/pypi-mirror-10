...
INFO_FMT = '>BIBBBHHIBHHIIHIH'

INFO_FIELDS = ('ver', 'time', 'type', 'charset', 'b_idx_len',
               'm_idx_len', 'range', 'db_items', 'id_len',
...
TYPES = ('n/a', 'SxGeo Country', 'SxGeo City RU', 'SxGeo City EN',
         'SxGeo City', 'SxGeo City Max RU', 'SxGeo City Max EN',
         'SxGeo City Max')
