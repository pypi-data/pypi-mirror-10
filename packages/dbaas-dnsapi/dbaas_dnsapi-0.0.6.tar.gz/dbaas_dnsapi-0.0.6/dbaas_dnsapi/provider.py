...
class DNSAPIProvider(object):
    ...
    @classmethod
    @transaction.commit_on_success
    def update_database_dns_ttl(self, environment, databaseinfraid, ttl):
    ...
    def update_dns_ttl(self, dnsapi, name, domain, ttl):
        ...
        dnsapi.update_record(record_id = record_id, name = record['name'], content = record['content'], ttl = ttl)
