...
setup(
  ...
  url = 'http://h12u.com/sphinx/gosyu/',
  license = 'BSD',
  description = 'Fix the Sphinx to enable any order to sort indices(using domain feature)',
  packages = find_packages(),
  package_data = {
    '' : [ 'sphinxcontrib/*', 'sphinxcontrib/gosyu/*',
  ...
  entry_points = {},
  install_requires = ['sphinx>=1.3', 'sortorder>=2.0'],
  platforms = 'any',
  classifiers = [
