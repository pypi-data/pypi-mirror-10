...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.storage_limit_override'
        db.add_column('assetcloud_account', 'storage_limit_override',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.storage_limit_override'
        db.delete_column('assetcloud_account', 'storage_limit_override')
