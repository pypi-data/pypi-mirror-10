...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['assetcloud.Folder'].objects.filter(name='Your Folder').update(name='Favourites')

    def backwards(self, orm):
        orm['assetcloud.Folder'].objects.filter(name='Favourites').update(name='Your Folder')
