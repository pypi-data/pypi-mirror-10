...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Create folders for all users who don't already have one. This is
        # exactly what 0028_initial_folders.py did, but we need to do it
        # again so that social auth users who were created since then and
        # have a missing folder (due to #126) get one.
