...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        account_ct = orm['contenttypes.ContentType'].objects.get(
            model='account', app_label='assetcloud')
        edit_assets = orm['auth.permission'].objects.get(
            content_type=account_ct, codename='edit_assets')

        viewers = orm['auth.group'].objects.create(name='viewers')
        editors = orm['auth.group'].objects.create(name='editors')

        editors.permissions.add(edit_assets)


    def backwards(self, orm):
        orm['auth.group'].objects.filter(name='editors').delete()
        orm['auth.group'].objects.filter(name='viewers').delete()
