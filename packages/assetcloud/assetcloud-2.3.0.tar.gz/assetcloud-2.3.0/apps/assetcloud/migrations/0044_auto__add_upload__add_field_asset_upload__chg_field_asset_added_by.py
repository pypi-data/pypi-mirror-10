...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Upload'
        db.create_table('assetcloud_upload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('assetcloud', ['Upload'])

        # Adding field 'Asset.upload'
        db.add_column('assetcloud_asset', 'upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assets', null=True, to=orm['assetcloud.Upload']),
                      keep_default=False)


        # Changing field 'Asset.added_by'
        db.alter_column('assetcloud_asset', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting model 'Upload'
        db.delete_table('assetcloud_upload')

        # Deleting field 'Asset.upload'
        db.delete_column('assetcloud_asset', 'upload_id')


        # Changing field 'Asset.added_by'
        # default shouldn't be needed because the backwards method in the 0045 data migration should have filled in this field
        db.alter_column('assetcloud_asset', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-987654321, to=orm['auth.User']))
