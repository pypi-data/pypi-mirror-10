...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssetDownloadLog'
        db.create_table(u'assetcloud_assetdownloadlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('asset', self.gf('django.db.models.fields.related.ForeignKey')(related_name='downloads', to=orm['assetcloud.Asset'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='downloads', null=True, to=orm['auth.User'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'assetcloud', ['AssetDownloadLog'])


    def backwards(self, orm):
        # Deleting model 'AssetDownloadLog'
        db.delete_table(u'assetcloud_assetdownloadlog')
    ...
    models = {
        ...
        u'assetcloud.assetdownloadlog': {
            'Meta': {'object_name': 'AssetDownloadLog'},
            'asset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'downloads'", 'to': u"orm['assetcloud.Asset']"}),
