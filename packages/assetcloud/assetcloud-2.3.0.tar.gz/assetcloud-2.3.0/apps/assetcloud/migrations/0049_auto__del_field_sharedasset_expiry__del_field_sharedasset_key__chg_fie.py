...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SharedAsset.expiry'
        db.delete_column('assetcloud_sharedasset', 'expiry')

        # Deleting field 'SharedAsset.key'
        db.delete_column('assetcloud_sharedasset', 'key')


        # Changing field 'SharedAsset.share'
        # default shouldn't be needed because the previous data migration should have filled in this field
        db.alter_column('assetcloud_sharedasset', 'share_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-987654321, to=orm['assetcloud.Share']))

    def backwards(self, orm):
        # Adding field 'SharedAsset.expiry'
        db.add_column('assetcloud_sharedasset', 'expiry',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SharedAsset.key'
        db.add_column('assetcloud_sharedasset', 'key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


        # Changing field 'SharedAsset.share'
        db.alter_column('assetcloud_sharedasset', 'share_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assetcloud.Share']))
