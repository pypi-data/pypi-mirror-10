...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('assetcloud_account', 'header_background', self.gf('assetcloud.models.ColourField')(max_length=7))

        # Changing field 'Account.header_links_active'
        db.alter_column('assetcloud_account', 'header_links_active', self.gf('assetcloud.models.ColourField')(max_length=7))

        # Changing field 'Account.header_links'
        db.alter_column('assetcloud_account', 'header_links', self.gf('assetcloud.models.ColourField')(max_length=7))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Account.header_background'
        db.alter_column('assetcloud_account', 'header_background', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'Account.header_links_active'
        db.alter_column('assetcloud_account', 'header_links_active', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'Account.header_links'
        db.alter_column('assetcloud_account', 'header_links', self.gf('django.db.models.fields.CharField')(max_length=7))
