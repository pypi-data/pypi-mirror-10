...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assetcloud_userprofile', 'activation_key', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.activation_key'
        db.delete_column('assetcloud_userprofile', 'activation_key')
    ...
    models = {
        ...
        'assetcloud.userprofile': {
            ...
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
