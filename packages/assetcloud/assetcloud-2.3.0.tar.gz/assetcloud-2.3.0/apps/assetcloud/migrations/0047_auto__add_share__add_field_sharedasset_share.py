...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Share'
        db.create_table('assetcloud_share', (
        ...
        db.send_create_signal('assetcloud', ['Share'])

        # Adding field 'SharedAsset.share'
        db.add_column('assetcloud_sharedasset', 'share',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shared_assets', null=True, to=orm['assetcloud.Share']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Share'
        db.delete_table('assetcloud_share')

        # Deleting field 'SharedAsset.share'
        db.delete_column('assetcloud_sharedasset', 'share_id')
    ...
    models = {
        ...
        'assetcloud.sharedasset': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
            'share': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'shared_assets'", 'null': 'True', 'to': "orm['assetcloud.Share']"})
        },
        'assetcloud.upload': {
