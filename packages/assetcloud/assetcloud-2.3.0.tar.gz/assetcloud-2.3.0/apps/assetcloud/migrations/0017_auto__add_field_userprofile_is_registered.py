...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.is_registered'
        db.add_column('assetcloud_userprofile', 'is_registered', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.is_registered'
        db.delete_column('assetcloud_userprofile', 'is_registered')
