...
OLD_DEFAULT_WELCOME = 'Welcome to Asset Cloud, a tool for sharing and managing your digital assets.'
NEW_DEFAULT_WELCOME = 'Welcome to Asset Share, a tool for sharing and managing your digital assets.'

class Migration(DataMigration):

    def forwards(self, orm):
        # Note: Remember to use orm['appname.ModelName'] rather than "from appname.models..."
        orm['assetcloud.Account'].objects.filter(welcome_text=OLD_DEFAULT_WELCOME).update(welcome_text=NEW_DEFAULT_WELCOME)

    def backwards(self, orm):
        orm['assetcloud.Account'].objects.filter(welcome_text=NEW_DEFAULT_WELCOME).update(welcome_text=OLD_DEFAULT_WELCOME)
