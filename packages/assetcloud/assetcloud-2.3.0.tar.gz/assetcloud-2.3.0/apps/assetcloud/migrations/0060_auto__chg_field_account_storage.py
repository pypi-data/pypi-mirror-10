...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.storage'
        db.alter_column('assetcloud_account', 'storage', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Account.storage'
        db.alter_column('assetcloud_account', 'storage', self.gf('django.db.models.fields.IntegerField')())
