...
class Migration(DataMigration):
    ...
    # This used to be a FixtureMigration, but now its a no-op - the fixture
    # has been merged into 0005_create_userprofiles_and_clients to
    # 0001_initial to fix FK errors when applying
    # 0005_create_userprofiles_and_clients to PostgreSQL databases (and any
    # other DBs that enforce FKs) because
    # 0005_create_userprofiles_and_clients relies on the users that used to
    # be created by this migration existing.
    #fixture = '0016_initial_users.json'
