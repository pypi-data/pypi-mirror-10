...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.accepted_terms_and_conditions'
        db.add_column('assetcloud_userprofile', 'accepted_terms_and_conditions',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.accepted_aup'
        db.add_column('assetcloud_userprofile', 'accepted_aup',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.accepted_terms_and_conditions'
        db.delete_column('assetcloud_userprofile', 'accepted_terms_and_conditions')

        # Deleting field 'UserProfile.accepted_aup'
        db.delete_column('assetcloud_userprofile', 'accepted_aup')
    ...
    models = {
        ...
        'assetcloud.userprofile': {
            ...
            'accepted_aup': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'accepted_terms_and_conditions': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
