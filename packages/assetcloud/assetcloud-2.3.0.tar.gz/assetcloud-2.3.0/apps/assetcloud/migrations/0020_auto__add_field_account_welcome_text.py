...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.welcome_text'
        db.add_column('assetcloud_account', 'welcome_text',
                      self.gf('django.db.models.fields.TextField')(default='Welcome to Asset Cloud, a tool for sharing and managing your digital assets.', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.welcome_text'
        db.delete_column('assetcloud_account', 'welcome_text')
