...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assetcloud_account', 'subdomain',
                      self.gf('assetcloud.models.NullableCharField')(max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.subdomain'
        db.delete_column('assetcloud_account', 'subdomain')
