...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('assetcloud_asset', 'file', self.gf('assetcloud.models.QuotaValidatingFileField')(max_length=2048, size_field_name='file_size'))

    def backwards(self, orm):

        # Changing field 'Asset.file'
        db.alter_column('assetcloud_asset', 'file', self.gf('assetcloud.models.QuotaValidatingFileField')(max_length=100, size_field_name='file_size'))
