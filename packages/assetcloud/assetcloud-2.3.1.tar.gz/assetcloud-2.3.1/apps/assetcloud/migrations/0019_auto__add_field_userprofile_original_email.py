...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.original_email'
        db.add_column('assetcloud_userprofile', 'original_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.original_email'
        db.delete_column('assetcloud_userprofile', 'original_email')
    ...
    models = {
        ...
        'assetcloud.userprofile': {
            ...
            'original_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
