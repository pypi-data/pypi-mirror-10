...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountCancellation'
        db.create_table('assetcloud_accountcancellation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cancellations', to=orm['assetcloud.Account'])),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('extra_detail', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('can_contact_when_addressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('should_keep_data', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('assetcloud', ['AccountCancellation'])


    def backwards(self, orm):
        # Deleting model 'AccountCancellation'
        db.delete_table('assetcloud_accountcancellation')
    ...
    models = {
        ...
        'assetcloud.accountcancellation': {
            ...
            'can_contact_when_addressed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
