...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssetImageInfo'
        db.create_table('assetcloud_assetimageinfo', (
            ('asset', self.gf('django.db.models.fields.related.OneToOneField')(related_name='image_info', unique=True, primary_key=True, to=orm['assetcloud.Asset'])),
            ('height', self.gf('django.db.models.fields.IntegerField')()),
            ('width', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('assetcloud', ['AssetImageInfo'])


    def backwards(self, orm):
        # Deleting model 'AssetImageInfo'
        db.delete_table('assetcloud_assetimageinfo')
    ...
    models = {
        ...
        'assetcloud.assetimageinfo': {
            ...
            'asset': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'image_info'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['assetcloud.Asset']"}),
