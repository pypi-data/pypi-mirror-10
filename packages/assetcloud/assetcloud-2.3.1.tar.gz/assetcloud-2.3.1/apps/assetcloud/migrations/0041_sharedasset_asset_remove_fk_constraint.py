...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Change FK to non-FK
        db.alter_column('assetcloud_sharedasset', 'asset_id',
                        self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        # Change non-FK to FK
        db.alter_column('assetcloud_sharedasset', 'asset',
                        self.gf('django.db.models.fields.related.ForeignKey')(related_name='shared_instances', to=orm['assetcloud.Asset']))
