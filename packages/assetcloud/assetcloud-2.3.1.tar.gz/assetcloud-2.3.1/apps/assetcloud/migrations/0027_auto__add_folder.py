...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Folder'
        db.create_table('assetcloud_folder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='folders', to=orm['auth.User'])),
        ))
        db.send_create_signal('assetcloud', ['Folder'])

        # Adding M2M table for field assets on 'Folder'
        db.create_table('assetcloud_folder_assets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('folder', models.ForeignKey(orm['assetcloud.folder'], null=False)),
            ('asset', models.ForeignKey(orm['assetcloud.asset'], null=False))
        ))
        db.create_unique('assetcloud_folder_assets', ['folder_id', 'asset_id'])


    def backwards(self, orm):
        # Deleting model 'Folder'
        db.delete_table('assetcloud_folder')

        # Removing M2M table for field assets on 'Folder'
        db.delete_table('assetcloud_folder_assets')
    ...
    models = {
        ...
        'assetcloud.folder': {
            ...
            'assets': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'containing_folders'", 'symmetrical': 'False', 'to': "orm['assetcloud.Asset']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
