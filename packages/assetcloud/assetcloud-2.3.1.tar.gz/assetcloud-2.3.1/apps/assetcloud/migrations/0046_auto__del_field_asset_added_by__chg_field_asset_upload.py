...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.upload'
        # default shouldn't be needed because the previous data migration should have filled in this field
        db.alter_column('assetcloud_asset', 'upload_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-987654321, to=orm['assetcloud.Upload']))

    def backwards(self, orm):
        # Adding field 'Asset.added_by'
        db.add_column('assetcloud_asset', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Asset.upload'
        db.alter_column('assetcloud_asset', 'upload_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assetcloud.Upload']))
