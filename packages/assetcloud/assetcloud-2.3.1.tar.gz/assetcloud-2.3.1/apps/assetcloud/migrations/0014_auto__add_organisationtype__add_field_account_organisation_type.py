...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assetcloud_organisationtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('assetcloud', ['OrganisationType'])

        # Adding field 'Account.organisation_type'
        db.add_column('assetcloud_account', 'organisation_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assetcloud.OrganisationType'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OrganisationType'
        db.delete_table('assetcloud_organisationtype')

        # Deleting field 'Account.organisation_type'
        db.delete_column('assetcloud_account', 'organisation_type_id')
