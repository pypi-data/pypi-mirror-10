...
Help can be obtained by using standard help function, e.g.

>>>import LinAlg
>>>help(LinAlg)

will show what all of the classes and functions in the LinAlg module do.
Of course one can use help on any specific class or function.
