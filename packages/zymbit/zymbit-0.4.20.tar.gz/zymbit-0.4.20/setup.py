...
setup(name='zymbit',
      ...
      packages=['zymbit', 'zymbit.arduino', 'zymbit.commands', 'zymbit.compat', 'zymbit.linux', 'zymbit.messenger', 'zymbit.raspberrypi'],
      scripts=['scripts/emit.py', 'scripts/subscribe.py', 'scripts/zymbit'],
      data_files=data_files,
      long_description=open('README').read(),
      url='http://datavytals.com/',
      license='LICENSE',
