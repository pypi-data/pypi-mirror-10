...
geminicassandra load --test-mode -v test.query.vcf --skip-gerp-bp --skip-cadd -t snpEff -db $cassandra_ips -ks test_query_db --cores $n_cores --buffer-size $buffer_size
