...
# Imports =====================================================================
"""
AMQP binding for storage subsystem. See `edeposit.amqp.storage
<https://github.com/edeposit/edeposit.amqp.storage>`_ for details.
"""
import os
import sys
import os.path
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        ...
        description="""AMQP binding for storage subsystem."""
    )
    parser.add_argument(
        "action",
