...
Temperature data logger RC-4.

`Elitech
RC-4 <http://www.e-elitech.com/jingChuang3/shouYe.do?operate=doProductDetail&chanpinId=156>`__
...
-  Silicon Labs CP210x USB-UART bridge VCP driver.
...
1. Install CP210x USB-UART bridge VCP driver. Download and install
