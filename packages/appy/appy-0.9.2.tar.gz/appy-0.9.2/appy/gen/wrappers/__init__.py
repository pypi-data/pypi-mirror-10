...
class AbstractWrapper(object):
    ...
    pxTemplate = Px('''
     <html var="ztool=tool.o;                   user=tool.user;
                ...
                wideSkin=(cfg.skin == 'wide') or inPopup;
     ...
     <body style=":wideSkin and 'margin:0' or ''">
      ...
      <table class=":wideSkin and 'mainWide main' or 'main'"
          ...
          <tr valign="top">
           ...
           <td class="content">
            <table cellpadding="0" cellspacing="0" width="100%">
             <!-- Navigation strip -->
              <tr if="zobj and zobj.showNavigationStrip(layoutType, inPopup)"
    ...
    pxAjax = Px('''
     <x var="zobj=obj.o;    ztool=tool.o;    user=tool.user;
             ...
             field=ztool.getPxTarget(zobj, px);
             dir=ztool.getLanguageDirection(lang);
             dleft=(dir == 'ltr') and 'left' or 'right';
             dright=(dir == 'ltr') and 'right' or 'left';
             x=resp.setHeader('Content-type', ztool.xhtmlEncoding);
