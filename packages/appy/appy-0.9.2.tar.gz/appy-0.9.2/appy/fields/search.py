    ...
    pxResultList = Px('''
     ...
     <div if="inPopup and cbShown" align=":dleft">
      <input type="button"
             ...
             onclick=":'onSelectObjects(%s,%s,%s,%s,%s,%s,%s,%s)' % \
              (q(rootHookId), q(uiSearch.initiatorHook), \
               q(uiSearch.initiator.url), q(uiSearch.initiatorMode), \
