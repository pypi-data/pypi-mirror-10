//-----------------------------------------------------------------------------
//
//  $Id: shadowed.i 880 2015-01-01 16:10:37Z weegreenblobbie $
//
...
%feature("shadow") Nsound::AudioStream::swig_hook()
%{
...
def __getitem__(self,i):
    ...
    if isinstance(i, int):
        ...
        return Buffer(self.get_at_index(i))
        ...
        for index in indices:
            a[k] = Buffer(self.get_at_index(index))
            k += 1
