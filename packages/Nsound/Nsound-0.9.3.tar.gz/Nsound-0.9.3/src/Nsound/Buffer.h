//-----------------------------------------------------------------------------
//
//  $Id: Buffer.h 886 2015-01-08 03:41:53Z weegreenblobbie $
//
...
class circular_iterator
{
    ...
    circular_iterator & operator+=(uint32 i)
    {
        itor_ += i;
        if(itor_ >= data_.end())
        {
            itor_ = data_.begin() + (itor_ - data_.end());
        }
        return *this;
    }
...
class const_circular_iterator
{
    ...
    const_circular_iterator & operator+=(uint32 i)
    {
        itor_ += i;
        if(itor_ >= data_.end())
        {
