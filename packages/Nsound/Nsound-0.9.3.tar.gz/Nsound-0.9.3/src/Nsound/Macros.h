//-----------------------------------------------------------------------------
//
//  $Id: Macros.h 874 2014-09-08 02:21:29Z weegreenblobbie $
//
...
#ifndef NSOUND_EXCEPTIONS_ARE_ON
	#define NSOUND_EXCEPTIONS_ARE_ON 1
#endif
...
{
	#if defined( NSOUND_EXCEPTIONS_ARE_ON ) && ( NSOUND_EXCEPTIONS_ARE_ON == 1)
