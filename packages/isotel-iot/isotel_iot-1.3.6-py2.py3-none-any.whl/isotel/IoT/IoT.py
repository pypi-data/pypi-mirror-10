...
class Device:
    ...
    def get_records(self, parameter, time_from=None, time_to='last', limit=None, scale=None):
...
class Parameter:
    ...
    def get_records(self, time_from=None, time_to='last', limit=None, scale=None):
