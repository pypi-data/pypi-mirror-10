...
class ScoreAndBoolean:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ScoreAndBoolean, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ScoreAndBoolean, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _CharniakParser.new_ScoreAndBoolean(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_setmethods__["first"] = _CharniakParser.ScoreAndBoolean_first_set
    __swig_getmethods__["first"] = _CharniakParser.ScoreAndBoolean_first_get
    __swig_setmethods__["second"] = _CharniakParser.ScoreAndBoolean_second_set
    __swig_getmethods__["second"] = _CharniakParser.ScoreAndBoolean_second_get
    ...
    def __setitem__(self, index, val):
      if not (index % 2): 
        ...
        self.second = val
    __swig_destroy__ = _CharniakParser.delete_ScoreAndBoolean
    __del__ = lambda self : None;
ScoreAndBoolean_swigregister = _CharniakParser.ScoreAndBoolean_swigregister
ScoreAndBoolean_swigregister(ScoreAndBoolean)
...
class ScoreTree:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ScoreTree, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ScoreTree, name)
    __repr__ = _swig_repr
    def score(self, *args): return _CharniakParser.ScoreTree_score(self, *args)
    def __init__(self): 
        this = _CharniakParser.new_ScoreTree()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _CharniakParser.delete_ScoreTree
    __del__ = lambda self : None;
ScoreTree_swigregister = _CharniakParser.ScoreTree_swigregister
ScoreTree_swigregister(ScoreTree)

class ParseStats:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ParseStats, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ParseStats, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _CharniakParser.new_ParseStats()
        try: self.this.append(this)
        except: self.this = this
    __swig_setmethods__["numInGold"] = _CharniakParser.ParseStats_numInGold_set
    __swig_getmethods__["numInGold"] = _CharniakParser.ParseStats_numInGold_get
    __swig_setmethods__["numInGuessed"] = _CharniakParser.ParseStats_numInGuessed_set
    __swig_getmethods__["numInGuessed"] = _CharniakParser.ParseStats_numInGuessed_get
    __swig_setmethods__["numCorrect"] = _CharniakParser.ParseStats_numCorrect_set
    __swig_getmethods__["numCorrect"] = _CharniakParser.ParseStats_numCorrect_get
    def fMeasure(self): return _CharniakParser.ParseStats_fMeasure(self)
    def precision(self): return _CharniakParser.ParseStats_precision(self)
    def recall(self): return _CharniakParser.ParseStats_recall(self)
    __swig_destroy__ = _CharniakParser.delete_ParseStats
    __del__ = lambda self : None;
ParseStats_swigregister = _CharniakParser.ParseStats_swigregister
ParseStats_swigregister(ParseStats)

class ParserError:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ParserError, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ParserError, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _CharniakParser.new_ParserError(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _CharniakParser.delete_ParserError
    __del__ = lambda self : None;
ParserError_swigregister = _CharniakParser.ParserError_swigregister
ParserError_swigregister(ParserError)
log600 = cvar.log600

class LabeledSpan:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, LabeledSpan, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, LabeledSpan, name)
    __repr__ = _swig_repr
    __swig_setmethods__["start"] = _CharniakParser.LabeledSpan_start_set
    __swig_getmethods__["start"] = _CharniakParser.LabeledSpan_start_get
    __swig_setmethods__["end"] = _CharniakParser.LabeledSpan_end_set
    __swig_getmethods__["end"] = _CharniakParser.LabeledSpan_end_get
    __swig_setmethods__["termIndex"] = _CharniakParser.LabeledSpan_termIndex_set
    __swig_getmethods__["termIndex"] = _CharniakParser.LabeledSpan_termIndex_get
    def __init__(self, *args): 
        this = _CharniakParser.new_LabeledSpan(*args)
        try: self.this.append(this)
        except: self.this = this
    def size(self): return _CharniakParser.LabeledSpan_size(self)
    def disrupts(self, *args): return _CharniakParser.LabeledSpan_disrupts(self, *args)
    def __eq__(self, *args): return _CharniakParser.LabeledSpan___eq__(self, *args)
    def __ne__(self, *args): return _CharniakParser.LabeledSpan___ne__(self, *args)
    def __lt__(self, *args): return _CharniakParser.LabeledSpan___lt__(self, *args)
    __swig_destroy__ = _CharniakParser.delete_LabeledSpan
    __del__ = lambda self : None;
LabeledSpan_swigregister = _CharniakParser.LabeledSpan_swigregister
LabeledSpan_swigregister(LabeledSpan)

def stream_extraction(*args):
  return _CharniakParser.stream_extraction(*args)
stream_extraction = _CharniakParser.stream_extraction

class SpanConstraints:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SpanConstraints, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SpanConstraints, name)
    __repr__ = _swig_repr
    __swig_setmethods__["minSizeForParsing"] = _CharniakParser.SpanConstraints_minSizeForParsing_set
    __swig_getmethods__["minSizeForParsing"] = _CharniakParser.SpanConstraints_minSizeForParsing_get
    def __init__(self): 
        this = _CharniakParser.new_SpanConstraints()
        try: self.this.append(this)
        except: self.this = this
    def addConstraint(self, *args): return _CharniakParser.SpanConstraints_addConstraint(self, *args)
    __swig_getmethods__["spansFromTree"] = lambda x: _CharniakParser.SpanConstraints_spansFromTree
    def matches(self, *args): return _CharniakParser.SpanConstraints_matches(self, *args)
    def applyToChart(self, *args): return _CharniakParser.SpanConstraints_applyToChart(self, *args)
    def disrupts(self, *args): return _CharniakParser.SpanConstraints_disrupts(self, *args)
    __swig_destroy__ = _CharniakParser.delete_SpanConstraints
    __del__ = lambda self : None;
SpanConstraints_swigregister = _CharniakParser.SpanConstraints_swigregister
SpanConstraints_swigregister(SpanConstraints)

def SpanConstraints_spansFromTree(*args):
  return _CharniakParser.SpanConstraints_spansFromTree(*args)
SpanConstraints_spansFromTree = _CharniakParser.SpanConstraints_spansFromTree


def getParseStats(*args):
  return _CharniakParser.getParseStats(*args)
getParseStats = _CharniakParser.getParseStats

def fscore(*args):
  return _CharniakParser.fscore(*args)
fscore = _CharniakParser.fscore

def treeLogProb(*args):
  return _CharniakParser.treeLogProb(*args)
treeLogProb = _CharniakParser.treeLogProb
...
class LabeledSpans:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, LabeledSpans, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, LabeledSpans, name)
    __repr__ = _swig_repr
    def iterator(self): return _CharniakParser.LabeledSpans_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _CharniakParser.LabeledSpans___nonzero__(self)
    def __bool__(self): return _CharniakParser.LabeledSpans___bool__(self)
    def __len__(self): return _CharniakParser.LabeledSpans___len__(self)
    def pop(self): return _CharniakParser.LabeledSpans_pop(self)
    def __getslice__(self, *args): return _CharniakParser.LabeledSpans___getslice__(self, *args)
    def __setslice__(self, *args): return _CharniakParser.LabeledSpans___setslice__(self, *args)
    def __delslice__(self, *args): return _CharniakParser.LabeledSpans___delslice__(self, *args)
    def __delitem__(self, *args): return _CharniakParser.LabeledSpans___delitem__(self, *args)
    def __getitem__(self, *args): return _CharniakParser.LabeledSpans___getitem__(self, *args)
    def __setitem__(self, *args): return _CharniakParser.LabeledSpans___setitem__(self, *args)
    def append(self, *args): return _CharniakParser.LabeledSpans_append(self, *args)
    def empty(self): return _CharniakParser.LabeledSpans_empty(self)
    def size(self): return _CharniakParser.LabeledSpans_size(self)
    def clear(self): return _CharniakParser.LabeledSpans_clear(self)
    def swap(self, *args): return _CharniakParser.LabeledSpans_swap(self, *args)
    def get_allocator(self): return _CharniakParser.LabeledSpans_get_allocator(self)
    def begin(self): return _CharniakParser.LabeledSpans_begin(self)
    def end(self): return _CharniakParser.LabeledSpans_end(self)
    def rbegin(self): return _CharniakParser.LabeledSpans_rbegin(self)
    def rend(self): return _CharniakParser.LabeledSpans_rend(self)
    def pop_back(self): return _CharniakParser.LabeledSpans_pop_back(self)
    def erase(self, *args): return _CharniakParser.LabeledSpans_erase(self, *args)
    def __init__(self, *args): 
        this = _CharniakParser.new_LabeledSpans(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _CharniakParser.LabeledSpans_push_back(self, *args)
    def front(self): return _CharniakParser.LabeledSpans_front(self)
    def back(self): return _CharniakParser.LabeledSpans_back(self)
    def assign(self, *args): return _CharniakParser.LabeledSpans_assign(self, *args)
    def resize(self, *args): return _CharniakParser.LabeledSpans_resize(self, *args)
    def insert(self, *args): return _CharniakParser.LabeledSpans_insert(self, *args)
    def reserve(self, *args): return _CharniakParser.LabeledSpans_reserve(self, *args)
    def capacity(self): return _CharniakParser.LabeledSpans_capacity(self)
    __swig_destroy__ = _CharniakParser.delete_LabeledSpans
    __del__ = lambda self : None;
LabeledSpans_swigregister = _CharniakParser.LabeledSpans_swigregister
LabeledSpans_swigregister(LabeledSpans)
