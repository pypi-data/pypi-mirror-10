...
class JsonSession(BasicSession):
    ...
    def get(self, location, data=None, get_params=None, headers={}):
        """Perform an HTTP GET."""
        return self._communicate(request.GetRequest,
                                 location, data, get_params, headers)

    def post(self, location, data=None, get_params=None, headers={}):
        """Perform an HTTP POST."""
        return self._communicate(request.PostRequest,
                                 location, data, get_params, headers)

    def put(self, location, data=None, get_params=None, headers={}):
        """Perform an HTTP PUT."""
        return self._communicate(request.PutRequest,
                                 location, data, get_params, headers)

    def delete(self, location, data=None, get_params=None, headers={}):
    ...
    def _communicate(self, cls_type, location, raw_data,
        ...
        req_obj = cls_type(self._url + location + url_get_params,
