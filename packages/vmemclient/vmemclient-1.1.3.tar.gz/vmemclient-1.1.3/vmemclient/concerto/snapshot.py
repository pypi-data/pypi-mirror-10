...
class SnapshotManager02(SnapshotManager01):
    ...
    def get_snapshot_groups(self, name=None):
    ...
    def snapshot_group_name_to_object_id(self, name):
        ...
        """
        ans = self.get_snapshot_groups(name)
        if len(ans) == 0:
    ...
    def create_snapshot_group(self, name=None):
    ...
    def _update_luns_in_snapshot_group(self, action, name=None, lun_names=[],
                                       snapshot_group_object_id=None,
                                       lun_object_ids=[]):
        ...
        if snapshot_group_object_id is None:
            # Raises:  QueryError, NoMatchingObjectIdError
            snapshot_group_object_id = self.snapshot_group_name_to_object_id(
                                            name)
        for lun in lun_names:
            # Raises:  QueryError, NoMatchingObjectIdError,
            #          MultipleMatchingObjectIdsError
    ...
    def add_luns_to_snapshot_group(self, snapshot_group_name=None,
                                   lun_names=[],
                                   snapshot_group_object_id=None,
                                   lun_object_ids=[]):
        ...
        Arguments:
            ...
            lun_names                -- list
            snapshot_group_object_id -- string
            lun_object_ids           -- list
        ...
        """
        return self._update_luns_in_snapshot_group('join',
                    snapshot_group_name, lun_names,
                    snapshot_group_object_id, lun_object_ids)

    def remove_luns_from_snapshot_group(self, snapshot_group_name=None,
                                        lun_names=[],
                                        snapshot_group_object_id=None,
                                        lun_object_ids=[]):
        ...
        """
        return self._update_luns_in_snapshot_group('leave',
                    snapshot_group_name, lun_names,
                    snapshot_group_object_id, lun_object_ids)

    def delete_snapshot_group(self, name=None, object_id=None):
        ...
        if object_id is None:
            # Raises:  QueryError, NoMatchingObjectIdError,
            #          MultipleMatchingObjectIdsError
            object_id = self.snapshot_group_name_to_object_id(name)
    ...
    def create_group_snapshot(self, group=None, comment=None, priority=None,
                              enable_notification=None, group_object_id=None):
        ...
        if group_object_id is None:
            # Raises:  QueryError, NoMatchingObjectIdError,
            #          MultipleMatchingObjectIdsError
            group_object_id = self.parent.lun.lun_name_to_object_id(group)
